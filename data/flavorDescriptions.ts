...
// DEUS — 財務省公告に別表記で登録されている同一銘柄向けの共有説明
const DEUS_GUINNESS =
  'スタウトビールを模した、麦芽の甘みとホップの苦みにコーヒーやチョコのニュアンスが乗る味。htreviewsではDEUSでも上位の人気で (評価161件・4点61%・5点21%・リピート意向88%)、黒パンやクワスに近い香ばしさが好評。アルコール感は薄く、甘くない変化球として支持されるがミックス相手は選ぶ。'
const DEUS_PINK_GRAPEFRUIT =
  'ピンクグレープフルーツの果肉を思わせる甘酸っぱさに、ほのかな苦みと花のニュアンス。htreviewsではDEUSの中でも安定した高評価で (評価54件・4点61%・5点13%・リピート意向83%)、ソロでもミックスでも使いやすいと好評。ただしロットによってバラの香りが前に出るという報告があり、過熱にも弱い。'
...
export const FLAVOR_DESCRIPTIONS: Record<string, string> = {
  ...
  // DOZAJ — 日本の販売元/卸 (tokyoshisha.com / シーシャ卸.com / NEWEMO SHISHA) の
  // 商品説明を要約 (2026-09 時点)。DOZAJ と DOZAJ BLACK の両ラインを含む。
  // 商品ページの本文が銘柄名の和訳のみの銘柄は、味の情報が無いため未記載。
  'dozaj:acai':
    'アサイーを再現したフルーツ系フレーバー。販売元の説明では、ブルーベリーのような豊かな酸味とココアを思わせる風味が特徴とされる。',
  'dozaj:bergamot tea':
    'ベルガモットの清涼感ある香りに、アールグレイに似た茶葉の豊かな香りを重ねたティー系フレーバー。濃厚さと繊細さを併せ持つ味わいとされる。',
  'dozaj:biscuit':
    '素朴な味わいのビスケット系フレーバー。ミックスに加えると柔らかく甘い仕上がりになり、お菓子系のミックスに向くとされる。',
  'dozaj:black pink flight':
    'グレープフルーツ、ストロベリー、ラズベリーを組み合わせたベリー系のミックスフレーバー。',
  'dozaj:black smoothie':
    'ストロベリー、バナナ、ベリーを合わせた、スムージーをイメージしたミックスフレーバー。',
  'dozaj:black tangerine soda':
    'タンジェリンのソーダ系フレーバー。販売元の説明ではシュウェップスに例えられる味わいとされる。',
  'dozaj:black tea':
    'ストレートティーを思わせる紅茶系フレーバー。ほんのりとした甘さを感じるバランスの良い味わいとされる。',
  'dozaj:blueberry':
    'ブルーベリーガムのような甘さが吸い始めから感じられるフレーバー。ミルク系やヨーグルト系のフレーバーとのミックスにも合うとされる。',
  'dozaj:dead sea':
    'コーラのような味わいにチェリーの豊かな酸味を合わせたミックス。ケミカルな風味は控えめで、クラフトコーラのような表情のある味わいとされる。',
  'dozaj:ice':
    'ミント系とは異なるエッジの効いた清涼感が主体のアイスフレーバー。販売元の説明では、本物の氷を口に頬張ったかのような刺激的な味わいとされる。',
  'dozaj:ice cream lemon':
    '酸味と軽い清涼感をともなうレモンアイス味。レモン菓子のような甘さとサクレを思わせる酸っぱさが組み合わさり、バランスの取れた仕上がりとされる。',
  'dozaj:kashmir':
    '香りの表現がはっきりした万能タイプのフレーバー。販売元の説明では、Tangiersのような重厚感はないものの香りはしっかり出るとされる。',
  'dozaj:kiwi':
    'キウイの青みと甘みを再現したジューシーなフレーバー。マンゴーやライチ、パイナップルと合わせた甘い南国系ミックスに向くとされる。',
  'dozaj:kola':
    '甘さはそこまで強くなく、スパイスの効いたクラフトコーラのような味わい。吐き心地にもスパイス感が残るタイプ。',
  'dozaj:lemon':
    'クラシックなレモンフレーバーとは異なり、レモン本来の酸味を忠実に出したタイプ。味わいはすっきりとしており、煙の質感もスムーズとされる。',
  'dozaj:lime':
    '柑橘感のはっきりした爽やかなライムの香りに、ほんのりした甘みと皮の渋みが乗る。さまざまなミックスに合わせやすいとされる。',
  'dozaj:mango':
    'マンゴージュースを思わせるフレーバー。青さはほとんどなく、甘さが全面に出る。',
  'dozaj:milk':
    'シルキーさと濃厚さを併せ持つミルクの甘さが主体。ナチュラルな甘みとコクのある煙が楽しめるとされる。',
  'dozaj:orange':
    'ジューシーな甘みを感じられる再現度の高いオレンジ。吐き心地には皮のピール感もあり、オレンジらしい香りが残る。',
  'dozaj:passion fruit':
    '吸いやすいフルーツの甘さに、少し癖のある酸味が乗るパッションフルーツ。販売元の説明では本物にかなり近い味で、パッションフルーツジャムのような仕上がりとされる。',
  'dozaj:peach':
    '甘いピーチキャンディーを思わせる味わいが主体のピーチ。桃の硬い部分のような青みがわずかに乗るが、あくまでアクセント程度で、ピーチらしさをまとめる香りとしてバランスが取られている。',
  'dozaj:pineapple':
    '果実感とジューシーさのあるパイナップルで、後味に酸味が残る。販売元の説明では、フルーツミックスやカクテル系など幅広いミックスに合わせやすいとされる。',
  'dozaj:strawberry yogurt':
    '糖度の高いストロベリーに、まろやかなヨーグルトの酸味を合わせた味わい。酸味と甘味のバランスが取られ、ストロベリーの甘味がアクセントとなってスイーツのような印象に仕上がる。',
  ...
  'bangbang:mint':
    '清涼感と甘みを両立させたミント。すっきりした冷たさの中に甘さが残る、ミント好き向けの一本とされる。',
  // Tokyo Shisha — 販売元 tokyoshisha.com の商品説明を要約 (2026-09 時点)。
  // Gold Line は Azure Gold Line と同一で、商品ページにもパッケージ切り替えのみで
  // 着香の内容は変わらない旨が明記されている銘柄がある。
  // 販売コピーの煽り・筆者の体験談は落とし、味の構成・開発経緯・推奨ミックスなど
  // 事実部分のみを要約している。商品ページが味に触れていない銘柄は未記載。
  'tokyo-shisha:gold line apple cider':
    'シナモンやジンジャーのスパイスを効かせたアップルサイダー系のフレーバー。りんごの果実味に温かみのあるスパイス感が重なる構成で、販売元はみずみずしい甘さの豊かさを楽しむ一本と説明している。',
  'tokyo-shisha:gold line barista s choice':
    '独自にローストしたコーヒー豆をブレンドした香りが主体のコーヒー系フレーバー。焙煎香を中心に据えた構成で、販売元は朝に一杯のコーヒーを飲むような味わいと説明している。',
  'tokyo-shisha:gold line bermuda mint':
    'ミントの甘みと清涼感を軸にした、複数のミント系を組み合わせたブレンド。煙当たりは比較的マイルドとされる一方、販売元はライン中で最も強いミントと説明しており、ミント好きに向けた一本となっている。',
  'tokyo-shisha:gold line berrymania':
    'ラズベリーを主体にした濃厚なベリー系フレーバー。輪郭のはっきりした濃いラズベリー感が出るため、ミックスでは3〜5割程度の配合でも味が立つとされる。グレープ、ブルーベリーミント、ローズ系などとの組み合わせが挙げられている。',
  'tokyo-shisha:gold line california blue':
    'ブルーベリーとミントを合わせた爽やかなフルーツミント。ベリーの甘さに涼感が重なるシンプルな構成で、日本ではスミレと呼ばれることもあるとされる。グレープやリモンチェッロ、パッションフルーツ、ライチなどとのミックスが挙げられている。',
  'tokyo-shisha:gold line candy':
    'ガムボールのような駄菓子系キャンディの甘さを再現したフレーバー。パッケージはAZURE Gold LineからTokyo Shisha Gold Lineへ順次切り替わるが、着香の内容に変更はないと販売元は説明している。',
  'tokyo-shisha:gold line carolina peach':
    '複数のピーチ系フレーバーを組み合わせた桃主体のブレンド。単一の桃香ではなく重ねた果実感で厚みを出す構成で、販売元は桃の産地として知られる街にちなんだみずみずしい味わいと説明している。',
  'tokyo-shisha:gold line chai masala':
    'スパイスの効いたチャイを軸に、癖のある中国茶やお香を思わせる香りが乗る独特なフレーバー。甘い菓子系よりもスパイス寄りで、好みが分かれるとされる。カシミアやアールグレー、チョコレートケーキなど茶・パン系とのミックスが挙げられている。',
  'tokyo-shisha:gold line chocolate cake':
    'ブラウニーを思わせる焼き菓子系のチョコレートケーキフレーバー。カカオの甘さが前に出るタイプで、販売元はココナッツを3割ほど足すとチョコ感が強まると紹介している。バニラやビスケット、シナモンクッキー、ベリー系とのミックスも挙げられている。',
  'tokyo-shisha:gold line cocomania':
    'ベリーミックスにココナッツの香りを効かせたトロピカル寄りのブレンド。ベリーの甘酸っぱさが軸となり、そこにココナッツが重なる構成。AZURE Gold LineパッケージからTokyo Shisha Gold Lineパッケージへ変更されたが、着香の内容は変わらないとされる。',
  'tokyo-shisha:gold line cool cucumber':
    'みずみずしいキューカンバーの風味に、強い清涼感が重なる一本。ほのかにメロンの皮のようなニュアンスが加わり、味全体に奥行きを与えるとされる。軽やかなウリの香りとゼスティな冷涼感の対比が輪郭になっている。',
  'tokyo-shisha:gold line copacabana':
    'フレッシュなウォーターメロンにミントを合わせた、スイカミント系のフレーバー。ブラジル・リオデジャネイロのビーチリゾート名を冠する。販売元は、日本では目立たないものの海外では各社が手掛ける人気のミックスだと説明している。',
  'tokyo-shisha:gold line cosmos':
    'みずみずしいグレープフルーツに、フレッシュなラズベリーを重ねた柑橘とベリーの二層構成。販売元は、爽やかなグレープフルーツとナチュラルなラズベリーのブレンドだと説明している。',
  'tokyo-shisha:gold line cucumelon':
    'キュウリとスイカを掛け合わせたような、青さと甘さが同居するウリ系の風味。メキシコでよく知られる小さなウリ、キューカメロン(マイクロキューリ)がモデルとされる。販売元はクールキューカンバーからミントを抜いてスイカの甘みを足した味わいと説明しており、青い香りが得意な人向けの変わり種。',
  'tokyo-shisha:gold line d cherry':
    '赤黒く色づいたダークチェリーの、ジャムのように濃厚な甘さが軸のフレーバー。チェリーパイに乗る濃いチェリージャムのような味わいとされる。販売元はTangiersのダークチェリーを参考に開発したと説明している。',
  'tokyo-shisha:gold line down under':
    'キウイ5・ブルーベリー3・アイス2の比率で組まれた、キウイブルーベリーアイス。Azureのオーストラリア法人が開発した現地限定フレーバーで、交渉を経て日本でも取り扱われるようになったという。オーストラリアで定番のキウイ×ブルーベリー×ミントのミックスを、最初から一つにまとめた構成とされる。',
  'tokyo-shisha:gold line dubai apple':
    'Azure版のダブルアップルで、リコリスとアニスを効かせた一般的なダブルアップルより、フルーティで吸いやすい方向に振られている。既存の定番に似せるのではなくオリジナルのダブルアップルを作ることがテーマだとされる。エスキモーコーラやウィンターレモン、カルダモンなどとのミックスが推奨されている。',
  'tokyo-shisha:gold line grapefruit':
    'グレープフルーツ単体で組まれた柑橘フレーバー。販売元は、既存のグレープフルーツ系に決定版が少ないという問題意識から、作りやすさと味持ちの良さをテーマにAzureで開発したと説明している。',
  'tokyo-shisha:gold line green tea':
    '抹茶フラペチーノをイメージして作られたグリーンティーフレーバーで、日本限定として展開される。黒糖やバニラビーン、チョコレートケーキ、カフェモカ、ミルク、バニラなどとのミックスが推奨されている。',
  'tokyo-shisha:gold line grow a pear':
    '木から落ちたての実をそのままかじるような、果汁感のあるみずみずしい洋梨の風味を掲げたフレーバー。販売元の説明も、熟した洋梨そのものの甘さと瑞々しさという一点に絞られている。',
  'tokyo-shisha:gold line guavi':
    'グアバの濃厚な甘みをベースに、キウイの鋭い酸味とライムの苦味を伴う酸味が時間差で重なる構成。吸い始めはトロピカルに甘く、吐き終わりはドライでビターへ移行するとされる。開発ではTart Edgeと呼ぶ酸味のキレを軸に未熟な果実のような青さを残したとされ、パン系とのミックスベースにも向く。',
  'tokyo-shisha:gold line ice pear':
    '甘みの強い西洋梨を思わせるジューシーな洋梨の香りが主体で、そこにアイスの清涼感を重ねた構成。販売元は、アイスを合わせることで吸いやすく飽きが来にくいよう工夫したと説明している。AZUREがフルーツ系に力を入れて作るラインの一つとされる。',
  'tokyo-shisha:gold line jasmine':
    '淹れたてのジャスミン茶の湯気を思わせる香りで、茶葉の渋みがベースにあり、吐いたあとに上品なホワイトフローラルが鼻に抜ける。甘さは控えめで、花の香りの再現ではなくお茶を飲む体験の再現を狙ったと販売元は説明している。レモンや洋梨と合わせるミックスが薦められている。',
  'tokyo-shisha:gold line jungle juice':
    'ねっとりとした完熟マンゴーの甘みと、パイナップルの弾けるようなジューシーさが前に出るトロピカル系。AZUREが得意とするガムミントが後味を引き締め、甘いわりに吸い疲れしにくいバランスとされる。販売元はやや強めの火力で炊いてマンゴーの甘さを引き出す使い方を薦めている。',
  'tokyo-shisha:gold line kokutou':
    '黒糖の甘さを主軸にした日本限定フレーバーの第二弾で、2022年にAZUREの工場で同社代表・調合師とともに作られたと販売元は説明している (第一弾はグリーンティー)。ミックスでは黒糖を70〜80%と多めに入れ、グリーンティーやバニラビーン、ミルク、アールグレーなどと合わせる使い方が薦められている。',
  'tokyo-shisha:gold line lemon muffin':
    'お菓子的なレモンの香りだけでなく、マフィンの小麦粉感まで出るレモンケーキ系のフレーバー。販売元はバニラやミルクを10%、アラスカンアイスを25%足すと再現度が上がるとしている。チョコレートケーキやココナッツ、キャラメルなどとのミックスも紹介されている。',
  'tokyo-shisha:gold line lemongrass':
    'フレッシュなシトラスに、レモングラス本来のナチュラルな風味を合わせたハーブ寄りの柑橘系フレーバー。販売元は、ゆったりとリラックスして楽しめる煙になると説明している。',
  'tokyo-shisha:gold line lime':
    'ジューシーな完熟ライムを思わせる、爽やかで軽い甘さのあるシトラス系フレーバー。酸味と苦味のバランスが取れており、単品でもミックスでも使い勝手がよいと販売元は説明している。',
  'tokyo-shisha:gold line lime cola':
    'コーラにライムを合わせた柑橘入りのコーラ系フレーバーで、店舗でよく注文されていた2つのミックスを1フレーバーにまとめた製品。販売元は単に混ぜたのではなく比率を詰めてバランスを取ったと説明しており、2023年にAZUREの工場での試吸を経て販売が決まったとされる。',
  'tokyo-shisha:gold line limoncello':
    'イタリアの伝統的なレモンリキュール、リモンチェッロをモチーフにした、はっきりした酸味の出るレモン系フレーバー。酸味好き向けとされ、販売元はバミューダミントと合わせるレモンミントを薦めている。メキシコーラやオレンジ、アールグレー、ダブルアップルなど幅広いミックスも紹介されている。',
  'tokyo-shisha:gold line lychee':
    'ソルティーライチを思わせる味と紹介されるライチ系フレーバーで、Tokyo Shishaでは創業の2019年から定番人気の一本とされる。製造元AZUREが世界的に知られるきっかけになった製品だと説明されている。パイナップルやバミューダミント、ベリー系、グレープフルーツなどとのミックスが薦められている。',
  'tokyo-shisha:gold line mango cheesecake':
    '角切りマンゴーをのせたチーズケーキをイメージしたデザート系フレーバー。チーズケーキの風味豊かな甘さに、マンゴーのフルーティーさを重ねた構成だと販売元は説明している。',
  'tokyo-shisha:gold line melonmania':
    '縁日のかき氷を思わせるメロンシロップの甘い香りが前面に出るメロンフレーバー。複数のメロン系香料をブレンドして甘さのある煙に仕上げたと販売元は説明しており、一般的なメロンとは少し異なる風味を狙ったものとされる。',
  'tokyo-shisha:gold line mexicola':
    'メキシコの瓶入りコーラから着想したとされるコーラ系フレーバー。甘味を感じさせつつも後味はすっきりと爽やかで、重くなりすぎないコーラとして構成されている。既存のコーラとは別解釈の一本という位置づけで紹介されている。',
  'tokyo-shisha:gold line napa grape':
    '白ぶどうを軸にした爽やかなグレープフレーバー。ワインを思わせる上品で豊かな香りが乗り、熟したぶどうの甘さも感じられると販売元は説明している。カリフォルニアのぶどう産地で造られるワインをイメージした一本とされる。',
  'tokyo-shisha:gold line new grape mint':
    '爽やかな甘さのグレープに、強すぎないミントを合わせたフレーバー。清涼感はみずみずしいフレッシュさを添える程度に抑えられ、吸いやすさを重視した構成とされる。白ワイン風味の同社Napa Grapeとは対になるグレープ系。',
  'tokyo-shisha:gold line orange crush':
    '透明感のあるみずみずしいオレンジが主体で、同社のライチに近い軽やかな出方をするフレーバー。オレンジソーダ系の味を手本に、シンプルなフルーツの決定版として2023年にAZUREの工場で作られたとされる。ダークリーフのため葉の強さに慣れた人向け。',
  'tokyo-shisha:gold line papaya':
    '甘くユニークな南国フルーツ、パパイヤの香りを主体にしたトロピカル系フレーバー。味の系統としてはマンゴーやマンゴスチン、パッションフルーツなど同社の南国フルーツ系に近く、それらを好む人に向くと販売元は説明している。',
  'tokyo-shisha:gold line passion fruit':
    '甘さとさっぱりした酸味が同居する、常夏系のパッションフルーツフレーバー。単体でも成立する一方、マンゴーやグァバ、パインなど他のトロピカル系と合わせても馴染みやすく、ミックス用途にも使いやすいと販売元は説明している。',
  'tokyo-shisha:gold line pep cream':
    'ペパーミントを土台に、優しいバニラの甘さが顔を出すクリーム系のミントフレーバー。キャンディケインをミルクシェイクに溶かしたような滑らかな甘さとされ、ミックスの土台にも向く構成だと説明されている。',
  'tokyo-shisha:gold line pina colada':
    'パイナップルとココナッツミルクを合わせたカクテル、ピニャコラーダをイメージしたトロピカル系フレーバー。販売元はミックス先としてアラスカンアイスを挙げており、2020年の売上上位に入る定番の一つとして扱われている。',
  'tokyo-shisha:gold line pineapple express':
    '透明感のあるみずみずしいパイナップルが主体のフレーバー。AZUREブラックラインのパイナップルを手本に、シンプルなフルーツの決定版として2023年にAZUREの工場で作られたとされる。生のパインに近い刺激のある香りが出るという。',
  'tokyo-shisha:gold line pinky':
    'ピンクグレープフルーツとストロベリーを軸に、ラズベリーを少し効かせたベリーと柑橘のミックス系フレーバー。MustHave社の「ピンクマン」を気に入ったAZURE代表が、同系統を目指して作ったものだと販売元は説明している。',
  'tokyo-shisha:gold line pomegranate':
    '果実感を重視したザクロのフレーバーで、シロップ的な甘さではなく果実そのものの味を狙ったと販売元は説明している。口当たりは滑らかでフルーティーな方向とされる。',
  'tokyo-shisha:gold line queen of fruits':
    'マンゴスチンをテーマにした、トロピカルフルーツの甘さと優しい透明感を併せ持つフレーバー。販売元はHookahHookah社のMangosteenを現代に再現したものと説明し、AZUREのライチ、ロイヤルマンゴー、トロピカルパラダイス、パッションフルーツを好む人に向くとしている。',
  'tokyo-shisha:gold line raspberry vanilla':
    '濃厚なラズベリーにバニラビーンズの甘い香りが重なるベリー系フレーバー。販売元はAZUREのロイヤルラズベリー70%にバニラビーン30%を合わせたようなバランスのミックスだと説明している。',
  'tokyo-shisha:gold line rio mint':
    '突き抜けるような爽快感と、辛みの立つミントが主体のミント単体フレーバー。販売元は甘さを伴う強めのペパーミントと説明しており、清涼感を求める場面や他フレーバーの底上げに向く方向性とされる。',
  'tokyo-shisha:gold line root beer':
    'ウィンターグリーンの清涼感と甘いバニラのニュアンスを併せ持つ、アメリカンソーダを再現したルートビアフレーバー。販売元は再現度の高さを特徴として挙げている。',
  'tokyo-shisha:gold line royal mango':
    '木から採れたてのような完熟マンゴーの甘さを素直に出したマンゴーフレーバー。販売元は熟した果実の甘さをそのまま表現した味と説明している。',
  'tokyo-shisha:gold line royal queen':
    '紅茶に柑橘を合わせた、ナチュラルな味わいのティー系フレーバー。販売元は英国の紅茶を思わせる自然な仕上がりだと説明している。',
  'tokyo-shisha:gold line royal raspberry':
    'ナチュラルなラズベリーの甘酸っぱさを前面に出したベリー系フレーバー。販売元は上品さと主張を併せ持つ味わいだと説明している。',
  'tokyo-shisha:gold line solana beach':
    'かき氷のメロンシロップを思わせる甘いメロン系の味が主体のミックスフレーバー。販売元は同社のHokkaido MelonやMelonmaniaに近い方向で、TangiersのForeplay on the Peach (メロン系×ピーチ系) をイメージして作られたと説明している。',
  'tokyo-shisha:gold line sour':
    'パインやグレープフルーツ、レモンを思わせる柑橘系のさっぱりとした酸味が主体のフレーバー。販売元はエジプシャンボウルで組むと酸味がより出るとし、メインのフルーツフレーバーに30〜40%足すミックスを薦めている。',
  'tokyo-shisha:gold line spiced berry':
    '熟したベリーの自然な甘さに、シナモンやアニスに近いスパイスのアクセントを効かせたフレーバー。販売元はスパイスが苦手な人でも吸いやすいまろやかなテイストだと説明している。',
  'tokyo-shisha:gold line strawberry guava':
    'ストロベリーが主体で、グァバの風味はほとんど感じられないと販売元は説明している。そのぶんクセの少ないシンプルなイチゴとして使いやすく、パッションフルーツやライチ、ブルーベリー、バニラ、ミント系クリームなどとのミックスが推奨されている。',
  'tokyo-shisha:gold line strawberry passion':
    'ストロベリーにパッションフルーツを合わせた、スッキリとしたフルーツミックス。イチゴの果実感とパッションフルーツの爽やかさのバランスが取られた構成とされ、同社のストロベリー系ブレンドのひとつとして位置づけられている。',
  'tokyo-shisha:gold line strong lychee':
    '濃厚なライチを前面に出したフレーバーで、AZUREの定番ライチをより香り豊かに濃く仕上げた2024年版と説明されている。盛る量やボウルによって味が薄く感じられるという声を受けた改良で、条件を選ばず濃さが出るよう作られたとされる。',
  'tokyo-shisha:gold line twisted teabag':
    'しっかりした紅茶のコクに、明るい柑橘の香りを重ねたスイートレモンティー系のフレーバー。甘すぎない上品な仕上がりとされ、紅茶好きに向けて紅茶とシトラスのバランスを取ったブレンドだと説明されている。',
  'tokyo-shisha:gold line viva la horchata':
    'ライスの風味にシナモンを組み合わせた、メキシコの飲み物オルチャータをイメージしたフレーバー。米の穏やかな味わいにシナモンのスパイス感が重なる構成で、販売元は本場のオルチャータを飲んでいるような味わいと説明している。',
  'tokyo-shisha:gold line wasabi':
    'ポテトチップスのワサビ味に近い、穏やかなワサビ風味のフレーバー。鼻に抜ける強い辛さは出ていないと販売元自身が説明しており、日本限定フレーバーの第三弾として試験的・限定的に発売された。ミントやケインミント、カルダモン、グレナディンとのミックスが推奨されている。',
  'tokyo-shisha:gold line watermelon':
    '甘くさっぱりとしたスイカのフレーバー。スイカバーを思わせる瑞々しい甘さが軸で、重さの少ないジューシーな果実感が続く。販売元は夏の終わりの集まりに合わせやすいフレーバーとして紹介している。',
  'tokyo-shisha:gold line white gummi bear':
    'パイナップルをメインに据えたフルーツミックスグミ系のフレーバー。トロピカルなニュアンスを効かせた甘いフルーツの香りが中心で、ホワイトグミベアを思わせる味わいだと説明されている。',
  'tokyo-shisha:gold line winter berries':
    '甘く穏やかなベリーの風味に、優しい清涼感を重ねたフレーバー。冷涼感は強すぎず、ベリーの甘さとのバランスを取った構成とされ、販売元は冬の冷たい風のようなクーリングにベリーが乗ると説明している。',
  'tokyo-shisha:gold line winter rose':
    'ミントの冷涼感に、ローズの個性的なフローラルノートを合わせたフレーバー。清涼感が土台にあり、そこに花の香りが重なる構成で、販売元は華やかな場面に向くブレンドと説明している。',
  // Debaj — 日本の販売元/卸 (tokyoshisha.com / シーシャ卸.com) の商品説明を要約 (2026-09 時点)。
  // 財務省公告には同一銘柄が「<名前>」と「<名前> Flavor」の 2 通りで登録されている
  // ものがあり、その場合は同じ商品ページを出典として同じ説明を共有する。
  // 在庫案内・アウトレット注記・販促文言は落とし、味の構成のみを要約している。
  'debaj:banana cake':
    'バナナの豊かな甘みに、バターを使ったケーキ生地のような優しい味わいが重なるスイーツ系フレーバー。追いバナナや好みのフルーツを足して、目指すスイーツの方向に寄せる使い方が向く。',
  'debaj:blueberry':
    'ブルーベリーガムを思わせる、王道のブルーベリー単体フレーバー。吸い始めにさっぱりとした酸味が立ち、それがすぐ引いてしつこくない甘さが残る。販売元の説明ではAl Fakherのブルーベリーより爽やかで作りやすく、他のフルーツとのミックスにも合うとされる。',
  'debaj:bounty flavor':
    'チョコレートとココナッツを合わせた甘いミックスフレーバー。販売元の説明では味は重めで、吸ったときの喉へのキックが強く、ダークリーフの重さを好む人向けとされる。熱管理に不安があればファンネルボウル、慣れていればエジプシャンボウルが薦められている。',
  'debaj:brazilliana flavor':
    '柑橘系の清涼感に、ウリ系のさっぱりとした酸味を重ねたミックスフレーバー。いつものさっぱり系ミックスに変化を付けたいときに向く。',
  'debaj:cappuccino':
    '吸ったときの重さは抑えめで、自然な質感の濃厚なカプチーノ香を楽しめるフレーバー。',
  'debaj:cardamon':
    'カレーやコーヒー、紅茶にも使われるカルダモンの、癖の強い香辛料香が前面に出るスパイス系フレーバー。ティー系やコーヒー系に混ぜて香りに奥行きを足したり、柑橘系フルーツのアクセントに使う用途が挙げられている。販売元の説明ではミックス時に香りが際立ちやすいとされる。',
  'debaj:cardamon coffee':
    'ほのかに香るカルダモンに、ビターなコーヒーを合わせたフレーバー。そのままでも成立する組み合わせで、好みのフレーバーを重ねるミックスのベースにも向く。',
  'debaj:cardamon milk':
    'カルダモンのスパイス感に、シルキーでマイルドなミルクを合わせたフレーバー。お菓子系フレーバーにアクセントを加える使い方も薦められている。',
  'debaj:cherry':
    '甘酸っぱさの後に、杏仁豆腐のような滑らかさが口に残るチェリー。販売元の説明では単体よりも他のフルーツとのミックスに向くとされる。',
  'debaj:chocolate':
    '生のチョコレートを食べているような再現度のチョコレートフレーバー。芳醇で甘い香りが立つ。',
  'debaj:cinnamon':
    '主張が強すぎず、飽きのこないスパイス香を楽しめるシナモン。飲食物にも広く使われる香りのため、ミックスの相手は好みに合わせて選びやすい。',
  'debaj:citrus':
    '落ち着いた柑橘香を持つ、バランスの取れた柑橘系ミックス。主張が強すぎないため、他の柑橘フレーバーに重ねて全体をまとめる役として使いやすいとされる。',
  'debaj:coffee milk':
    '深煎りで淹れたコーヒーのような香りに、ミルクを合わせた濃厚なコーヒー系フレーバー。ビターさとミルキーな甘さが同居した味わいを楽しめる。',
  'debaj:cola flavor':
    '甘さのしっかりしたコーラの味わいが楽しめるフレーバー。販売元の説明では、清涼感やフルーツ、スパイスを足してクラフトコーラ風に組み立てる使い方が向くとされる。',
  'debaj:guava':
    'ウリのような瓜系の風味が強めに出るグァバ。酸味とジューシーさもあり、甘い系・さっぱり系どちらの組み合わせにも合わせやすいとされる。',
  'debaj:guava flavor':
    'ウリのような瓜系の風味が強めに出るグァバ。酸味とジューシーさもあり、甘い系・さっぱり系どちらの組み合わせにも合わせやすいとされる。',
  'debaj:ice black grape flavor':
    '飲みごたえのある濃厚なグレープジュースを思わせる味わいのグレープフレーバー。ミントの清涼感を合わせて吸いやすく仕上げられている。',
  'debaj:ice spicy cola':
    'コーラにスパイスと清涼感を加えた、クラフトコーラのような味わい。構成はシンプルで、さまざまなフレーバーと組み合わせやすいとされる。',
  'debaj:ice spicy cola flavor':
    'コーラにスパイスと清涼感を加えた、クラフトコーラのような味わい。構成はシンプルで、さまざまなフレーバーと組み合わせやすいとされる。',
  'debaj:kiwi':
    '酸味の中に甘さがしっかりと詰まったキウイ。甘い系にもさっぱり系にも合わせられる万能さがあるとされる。',
  'debaj:lemon':
    'ちょうど良い甘さと酸味が同居するレモン。香りも良く、さまざまなフレーバーへのミックス用途に使いやすいとされる。',
  'debaj:melon':
    'メロンの一番甘い部分を思わせる、日本人好みの甘さに寄せたメロンフレーバー。熱が入ると少し酸味も出るとされ、他のメロンやフルーツ系と重ねて甘さを足す使い方にも向く。',
  'debaj:milk':
    '濃厚なミルクの甘みが前に出るミルクフレーバー。販売元の説明ではクセがなく味も立ちやすいとされる。',
  'debaj:milk flavor':
    '濃厚なミルクの甘みが前に出るミルクフレーバー。販売元の説明ではクセがなく味も立ちやすいとされる。',
  'debaj:mint flavor':
    '同ブランドのストロングミントより穏やかな清涼感のミント。販売元の説明ではAl Fakherのミントよりスペアミント感が加わった味とされ、幅広いフレーバーと合わせやすい万能タイプ。',
  'debaj:orange':
    '日本の蜜柑のような、優しい風味のオレンジフレーバー。販売元の説明ではファンネルボウルとの相性が良いとされる。',
  'debaj:peach cream':
    '熟れた桃にふわふわの生クリームを添えたデザートのような、上品な甘みのピーチクリームフレーバー。',
  'debaj:power passion':
    '青臭さがほとんどない、フレッシュなパッションフルーツ。酸味と甘いフルーツ感のバランスが取れており、さっぱりしたフルーツ系を好む人向けとされる。',
  'debaj:raspberry flavor':
    '甘くて濃厚なラズベリーフレーバー。はっきりした甘味と酸味があって味の輪郭が明確で、ミックスでの汎用性も高いとされる。',
  'debaj:sea mint':
    '透明感のあるミントフレーバー。優しい歯磨き粉のような印象で、ミント本来の甘みも感じられる。',
  'debaj:sea mint flavor':
    '透明感のあるミントフレーバー。優しい歯磨き粉のような印象で、ミント本来の甘みも感じられる。',
  'debaj:strawberry':
    '甘さは程よく、ストロベリーらしい酸味もほんのり感じられるフレーバー。販売元の説明ではお菓子系フレーバーとのミックスとの相性が良いとされる。',
  'debaj:strawberry cake':
    '熟したストロベリーに、クリームの甘さとケーキ生地の風味を重ねたスイーツ系フレーバー。ストロベリーの酸味が加わることで甘さが単調になりにくく、飽きの来ない味わいに仕上がっているとされる。',
  'debaj:strong mint':
    '食用ミントを思わせるドライな風味を持つストロングミント。販売元の説明では、同じ強ミント系でも他銘柄とは異なる方向性の味わいとされる。',
  'debaj:two apple mint flavor':
    'クラシックなリコリスとアニスの味わいが軸のダブルアップルミント。気圧の変化や急激な温度変化により、多少の液漏れが生じる場合があるとされる。',
  'debaj:zafran pan flavor':
    'サフランとインドの噛みタバコをミックスさせたような、フローラル寄りのパンラズナ系フレーバー。販売元の説明では、すっきりと吸いやすい味わいとされる。',
  // JiBiAR — 日本の卸 (シーシャ卸.com) の商品説明を要約 (2026-09 時点)。
  // 販促文言は落とし、味の構成とミックス適性のみを要約している。
  // 商品ページが味に触れていない銘柄は未記載。
  'jibiar:almond tofu':
    '杏仁豆腐を再現したスイーツ系のフレーバー。販売元の説明では再現度の高い味わいとされ、お菓子・スイーツ系が好みの人に向くとされる。',
  'jibiar:baked peach':
    '名前の通り甘さが凝縮したジューシーなピーチ。単体でも成立するが、他のフルーツとミックスするとまとまりが出るとされる。',
  'jibiar:banana':
    '甘さとジューシーさを備えたバナナで、販売元の説明では再現度が高いとされる。フルーツと合わせてトロピカルにする使い方も、お菓子系フレーバーに重ねる使い方も向く。',
  'jibiar:biscuit':
    'お菓子系にありがちな甘さの強い方向ではなく、落ち着いた上品なビスケットの味わい。',
  'jibiar:black grape':
    'グレープのジューシーな甘さがわかりやすく出るフレーバー。甘い方向にもさっぱりした方向にも合わせられ、ミックスの汎用性が高い。',
  'jibiar:blue mist':
    'ブルーベリーミント系のミックスで、ブルーベリーは柔らかめの出方。ブルーベリーを重ねたり、他のフルーツと合わせる使い方が向く。',
  'jibiar:blue orange':
    'ブルーベリーとオレンジのミックスフレーバー。吸い始めはアイス感があるが、すぐに落ち着くため味の変化も楽しめる。',
  'jibiar:blueberry':
    '熟す前のブルーベリーを思わせる、さっぱりとした味わい。',
  'jibiar:chai lemon':
    '茶葉感が前に出るティー系のフレーバー。チャイというよりは、レモンティーに近い方向の味わい。',
  'jibiar:choco ice':
    'アイス感の主張は強くなく、チョコバニラの味わいが中心。チョコのビター感は控えめで、甘さが立つのが特徴。',
  'jibiar:cigar':
    '甘い葉巻を思わせるフレーバー。少量加えるだけで落ち着いた味わいになり、販売元はシーシャのボトルにダークラムを入れる使い方も勧めている。',
  'jibiar:cinnamon gum':
    'シナモンの香りにガムのような爽やかさを合わせたフレーバー。販売元の説明では、他のJiBiARフレーバーに少量加えるだけでも雰囲気を出せるとされる。',
  'jibiar:dejavu':
    'スイカ、メロン、バニラ、ミントを組み合わせた甘くすっきりとした構成。単体でも吸い進めるうちに味の変化が感じられるとされる。',
  'jibiar:golden rose':
    '柔らかなローズが主体で、レモンのような爽やかさもわずかに感じられる。販売元の説明では他社のローズより穏やかな出方で、ローズ系を初めて試す人にも向くとされる。',
  'jibiar:happy mango':
    'ほんのりとしたアイス感を伴うマンゴーのフレーバー。販売元の説明では日本人の好みに合う味わいに仕上げられているとされる。',
  'jibiar:honey':
    '蜂蜜そのものを思わせる甘い味わいのフレーバー。味の持ちがよく、少量を加えるだけでも楽しめるとされる。',
  'jibiar:ice':
    '甘さを伴う柔らかな清涼感が特徴のフレーバー。販売元の説明では他社のアイスに比べて当たりが穏やかとされる。',
  'jibiar:ice bonbon':
    '複数の味を組み合わせたミックス系で、パイナップルなどの甘さとパッションフルーツの酸味が感じられる。ほんのりとしたアイス感も加わる。',
  'jibiar:ice cola':
    'コーラにアイスを合わせ、両者のバランスをとったフレーバー。単体でもミックスでも使いやすいとされる。',
  'jibiar:ice green apple':
    '爽やかなグリーンアップルに適度な清涼感を合わせたフレーバー。販売元の説明では単体でも成立する構成とされる。',
  'jibiar:lemon':
    'ほんのりとした甘さとティー感を伴う穏やかなレモン。ミックスに使うと爽やかさが出て、ティー系と合わせてフルーツティー風に、他のフルーツと合わせてバランス調整にも使えるとされる。',
  'jibiar:lemon cake':
    'アイスも配合されるが清涼感は吸い始めが中心で、その後はレモンケーキの風味が持続する。しつこさを抑えた甘さの構成。',
  'jibiar:milk':
    '柔らかい味わいのミルクテイスト。単体で吸うよりも、他のフレーバーへアクセントとして少量加えるミックス向きとされる。',
  'jibiar:mint':
    '程よいミント感で、軽くさっぱりさせたいときに向くフレーバー。清涼感は強すぎず、爽やかなフルーツ系と合わせる使い方が挙げられている。',
  'jibiar:mint gold':
    'JiBiARのゴールドシリーズのミント。キリッとした清涼感が前に出る、爽やかな味わいとされる。',
  'jibiar:pistachio breeze':
    '安定したピスタチオの風味が長く続くフレーバー。豆らしい香ばしさがあり、甘さはくどくない方向にまとめられている。',
  'jibiar:power drink':
    'エナジードリンクを模したフレーバー。販売元の説明では有名エナジードリンクへの再現度が高いとされ、リフレッシュしたいときに向く。',
  'jibiar:strawberry':
    '甘めのストロベリーで、販売元の説明では再現度が高いとされる。フルーツ系のミックスはもちろん、お菓子系のミックスにも使える。',
  'jibiar:taiga':
    '針葉樹を思わせる森林系のフレーバー。さっぱりとした味わいで、気分をリフレッシュしたいときに向くとされる。',
  'jibiar:tiramisu':
    '吸い始めに少しレモン感があり、落ち着いてくると優しいティラミスの味わいへ変わる。',
  'jibiar:white chocolate':
    '序盤に軽いアイス感があり、それがすぐ引いた後はホワイトチョコの味わいが続く。販売元の説明では再現度が高いとされる。',
  'jibiar:yoghurt':
    '酸味と甘さのバランスがとれたヨーグルト系フレーバー。ベリー系を合わせてアサイーボウル風にするなど、好みのフルーツでアレンジする使い方が挙げられている。',
  // Social Smoke — 日本の販売元/卸 (シーシャ卸.com / NEWEMO SHISHA) の商品説明を要約 (2026-09 時点)。
  // 財務省公告には同一銘柄が「<名前>」と「<名前> 50g Tin Social Smoke Tobacco」の
  // 2 通りで登録されているため、両キーが同じ商品ページを出典として説明を共有する。
  'social-smoke:cali peach':
    'なめらかで爽やかな、ピーチキャンディのような味わい。',
  'social-smoke:chai latte':
    'シナモンが深く香るチャイラテのフレーバー。クローブやカルダモンといったチャイ特有のスパイスの奥行きに、ベースの紅茶風味が重なる構成。',
  'social-smoke:cigar':
    '天然たばこ葉のなめらかで深みのある香ばしさを表現したフレーバー。販売元の説明では、本格的なタバコ・葉巻の風味を好む人向けとされる。',
  'social-smoke:cigar 50g tin social smoke tobacco':
    '天然たばこ葉のなめらかで深みのある香ばしい味わいのフレーバー。販売元の説明では、本格的な葉巻・タバコ系の風味を求める向きに合う構成とされる。',
  'social-smoke:cinnamint':
    '爽やかなミントとホットシナモンを合わせたフレーバー。清涼感とスパイスの温かみが同居し、単品でもミックスの一角としても使いやすい構成。',
  'social-smoke:cinnamon roll':
    'シナモンロールの甘さと香りに加え、パン生地の小麦感まで感じられる味わい。',
  'social-smoke:citrus chill':
    '柑橘類のフレッシュな香りが立つ、すっきりとした味わい。メンソール感がしっかり効いており、清涼香の強い仕上がりとされる。',
  'social-smoke:dulce de leche':
    'ラテンアメリカの伝統的な糖菓ドゥルセ・デ・レチェを写した、キャラメル主体のフレーバー。ミルクの繊細な風味に砂糖菓子のような優しい甘さが重なり、甘くクリーミーな仕上がりとされる。',
  'social-smoke:french vanilla':
    '繊細でリッチなバニラの味わい。販売元の説明では上品な甘さで幅広い層に好まれるフレーバーとされる。',
  'social-smoke:ginger tea':
    '生姜のスパイシーな風味と紅茶の香りを合わせたフレーバー。ジンジャーの刺激と紅茶の風味が噛み合う構成とされる。',
  'social-smoke:golden delicious apple':
    '完熟したリンゴのジューシーでフルーティーな味わい。ピューレ入りのアップルジュースに例えられる濃厚さで、甘さと爽やかさをあわせ持つ。',
  'social-smoke:golden delicious apple 50g tin social smoke tobacco':
    '果樹園で完熟したゴールデンデリシャスを思わせる、ジューシーで濃厚なりんごの味わい。販売元の説明ではピューレ入りのアップルジュースのような密度があり、甘さとさわやかさを併せ持つとされる。',
  'social-smoke:hong kong milk tea':
    '滑らかな紅茶にミルクと砂糖を合わせたミルクティー風味のフレーバー。コンデンスミルクを思わせる香り高く濃厚な甘さで、香港式ミルクティーの雰囲気に寄せた構成とされる。',
  'social-smoke:hong kong milk tea 50g tin social smoke tobacco':
    '滑らかな紅茶にミルクと砂糖を合わせたミルクティー風味のフレーバー。コンデンスミルクを思わせる香り高く濃厚な甘さで、香港式ミルクティーの雰囲気に寄せた構成とされる。',
  'social-smoke:horchata cajeta':
    'メキシコのライスミルクとココナッツを混ぜた飲み物「オルチャータ」をベースにしたフレーバー。そこへキャラメルとシナモンをブレンドした、まろやかで甘みのある味わい。',
  'social-smoke:japanese yuzu':
    '日本の柚子を思わせる、華やかな柑橘のフレーバー。清涼感のある苦味と、柑橘系の中でも独特なシトラス香が特徴。',
  'social-smoke:japanese yuzu 50g tin social smoke tobacco':
    '日本の柚子を用いた柑橘系フレーバーで、清涼感のある苦味が特徴。柑橘のなかでも独創的とされるシトラス香が立ち、華やかな香りに寄せた構成とされる。',
  'social-smoke:lemon':
    '甘さと酸味が際立つレモンフレーバー。豊かなシトラス香を伴うレモンの酸味が主体で、販売元の説明ではケミカル剤を使用していないオーガニックなレモンを使っているとされる。',
  'social-smoke:lemon drop':
    '甘いレモンドロップのキャンディを思わせる味わい。柑橘系の甘酸っぱさが中心のフレーバー。',
  'social-smoke:lemon drop 50g tin social smoke tobacco':
    '甘いレモンドロップのような味わいの柑橘系フレーバー。',
  'social-smoke:lemon pie':
    'レモンの酸味と甘いクリームを組み合わせたお菓子系のミックスフレーバー。酸味と乳のコクが噛み合う構成。',
  'social-smoke:lemon pie 50g tin social smoke tobacco':
    'レモンの酸味と甘いクリームを組み合わせたお菓子系のミックスフレーバー。柑橘の酸味とクリームの甘さが噛み合う構成とされる。',
  'social-smoke:pear chill':
    'ジューシーで華やかなラ・フランス(洋梨)にミントの清涼感を合わせたミックスフレーバー。甘い洋梨の風味と滑らかなミントがバランスよく重なる構成とされる。',
  'social-smoke:pear chill 50g tin social smoke tobacco':
    'ジューシーで華やかなラ・フランス(洋梨)にミントの清涼感を合わせたミックスフレーバー。甘い洋梨の風味と滑らかなミントがバランスよく重なる構成とされる。',
  'social-smoke:pistachio breeze':
    '濃厚なピスタチオにバニラを重ねた、バニラビーンズ入りピスタチオアイスクリームのような味わい。別の販売元の説明ではバターと香ばしいサフランを加えたブレンドともされる。',
  'social-smoke:pistachio breeze 50g tin social smoke tobacco':
    '濃厚なピスタチオと甘いバニラが重なる、ピスタチオアイスクリームのような味わい。販売元の説明ではバニラビーンズ入りのアイスをイメージした構成で、バターのコクと香ばしいサフランを加えたブレンドとされる。',
  'social-smoke:watermelon chill':
    'スイカとミントの組み合わせ。スイカのみずみずしさに、ミントの爽快感が乗る構成。',
  'social-smoke:wild berry':
    '酸味豊かなワイルドストロベリーに清涼感のあるミントを合わせたベリー系ミックス。フルーツの青さは少なくすっきりとした味わいで、程よい酸味がアクセントになる。',
  // REVOSHI — 販売元 tokyoshisha.com の商品説明を要約 (2026-09 時点)。
  // 財務省公告名の「TOBACCO」「Flavored」は商品名の一部で、ライン名ではない。
  // 全銘柄共通の取扱注記 (液漏れ等) は説明に含めていない。
  // 商品ページが味に触れていない銘柄は未記載。
  'revoshi:tobacco biscuit flavored':
    'ビスケットを思わせるお菓子系のフレーバーで、小麦の香ばしさがしっかり出るとされる。販売元の説明では、甘い系のミックスに組み込みやすい定番として位置づけられている。',
  'revoshi:tobacco black grape flavored':
    '芳醇で濃厚なグレープの風味が軸のフレーバー。販売元の説明では、グレープ感の濃さがそのまま満足感につながる一本とされる。',
  'revoshi:tobacco double apple strong flavored':
    'リコリスの甘さを軸にしたダブルアップル。販売元の説明では、その甘さを簡単に引き出せる作りやすいフレーバーとされる。',
  'revoshi:tobacco eskimo lemon flavored':
    'お菓子のようなレモン感に、清涼感のあるミントを合わせたフレーバー。販売元の説明では、ミックスでの汎用性が非常に高いとされる。',
  'revoshi:tobacco eskimo pineapple flavored':
    'パイナップルの風味を軸にしたフレーバー。販売元の説明では、パイナップル系の中ではスッキリとした吸い口で、重さを感じにくい仕上がりとされる。',
  'revoshi:tobacco eskimo watermelon flavored':
    'よくあるシーシャのスイカ味に、ひんやりとしたアイス感を重ねたフレーバー。販売元はスイカバーの緑色の部分の味と表現している。ウォーターメロン系で出やすい煙の尖りや重さが出にくく、吸いやすいとされる。',
  'revoshi:tobacco float like butterfly flavored':
    'チョコレートを混ぜたような濃厚な甘味が出るフレーバー。3g程度の使用でも十分に楽しめるとされる。ダークリーフのため、人によってはニコチンやタールを重く感じることがある。',
  'revoshi:tobacco grape flavored':
    'グレープの定番として作られたフレーバー。販売元の説明では熱耐性が高めで、使い勝手のよさが特徴とされる。',
  'revoshi:tobacco kak dela trshkv flavored':
    'アールグレイのベルガモットにミントを合わせた紅茶系のフレーバー。ベルガモットの風味が強く、ミントとのバランスも取れているとされる。販売元の説明では味の持ちがよく煙量も出やすいため、ティーミックスのベースとして汎用性が高い。',
  'revoshi:tobacco kiwi flavored':
    'キウイの風味を軸にしたフレーバー。販売元の説明では、やや丸みのある吸い口で作りやすく使いやすいとされる。',
  'revoshi:tobacco mastic flavored':
    '黒胡椒を思わせるスパイシーさが前に出るマスティック (コショウボクの樹液) 系フレーバー。ミントが合わせてあり吸いやすくまとめられている一方、香りが濃くホースやパイプに残りやすい。販売元の説明では全体の2〜3割程度の配合でも十分に味が出るとされる。',
  'revoshi:tobacco orange flavored':
    'クラシックなオレンジの果実味に、穏やかでさっぱりとした後味が重なるフレーバー。販売元の説明では単体でもミックスでも使い勝手がよいとされる。',
  'revoshi:tobacco pancho villa flavored':
    '吸い進めるごとに複数のフルーツの味が入れ替わりで顔を出すミックスフルーツ系フレーバー。単一の果実味ではなく複層的な味の出方が特徴とされる。',
  'revoshi:tobacco strawberry flavored':
    'ショートケーキに乗ったイチゴを思わせる、ふんわりとしたバニラ感を伴うストロベリー。えぐみや重さは抑えられているとされる。',
  'revoshi:tobacco sweet pineapple flavored':
    '甘みのはっきりしたパイナップル系フレーバー。販売元の説明では、廃盤となったエスキモーパインに代わるパインとして位置づけられ、50g箱で手に入る点も利点とされる。AzureのAlaskan Iceを合わせると同系統のミックスになるという。',
  'revoshi:tobacco the shuffle flavored':
    'バニラのずしりと重い甘さが喉と肺にはっきり届くフレーバー。3g程度をミックスに加えるだけでバニラのアクセントが出るとされる。ダークリーフのため、人によってはニコチンやタールを重く感じる場合があると案内されている。',
  'revoshi:tobacco viva latam flavored':
    'グミベアの味わいを再現したグミ系フレーバー。販売元の説明では、グミの再現としては完成版とされる。',
  // Hookafina — 販売元 tokyoshisha.com の商品説明を要約 (2026-09 時点)。
  // 他社銘柄との比較は商品ページに書かれている範囲のみ引用している。
  'hookafina:blueberry lemonade':
    'ブルーベリーを主体に、レモネード風味を重ねて爽やかに仕上げたフレーバー。2015年頃に展開されていたレモネード&カクテルシリーズの復活品で、販売元の説明では独特なミックスが多く類似品の少ないシリーズとされる。',
  'hookafina:cucumber lemonade':
    'キュウリの風味をレモネードに合わせたウリ系フレーバー。販売元の説明ではHazeのCucumberitaに近い味筋で、AzureのCool Cucumberが好きな人にも響くとされる。アメリカで広がったキュウリ×ライム系の流れを汲む一本。',
  'hookafina:deja blu':
    '名前は独特だが、中身は各社が出している定番のブルーベリーミント。販売元の説明ではブルーベリーに少しケミカルな香りが乗り、芳香剤のようなフローラル寄りの仕上がりとされる。ローズやジャスミン、パン系とミックスすると本領を発揮する。',
  'hookafina:double melon blast':
    'ダブルメロンの名の通り甘いメロンを主役に、ウリ系の風味と強めのミントを重ねたフレーバー。販売元の説明では味もミントもはっきり出るタイプとされ、清涼感を求める場面にも向く。ウリ系フレーバーが好きな人に向いた構成。',
  'hookafina:dragon fruit':
    '珍しいドラゴンフルーツ単体のフレーバーで、Hookafinaの中でも特に個性的な位置づけ。透明感のあるさっぱりとしたフルーツ味で、甘さを強く押し出さない。フルーツ系のミックスに少量加える隠し味的な使い方に向くとされる。',
  'hookafina:grapefruit mint':
    'グレープフルーツにミントを合わせたシンプルな構成のフレーバー。同ブランドのPink Grapefruitと比べるとミントの分だけ甘みが抑えられ、より爽やかでさっぱりした仕上がり。Hookafinaが日本で知られるきっかけになったグレープフルーツ系の一つ。',
  'hookafina:limeade':
    'ライムを主役にしたフレーバーで、洗剤や芳香剤を思わせる方向のライムの香りが立つ。販売元の説明ではStarBuzz VintageのFresh Limeに酷似し、香料も同系統と見られるとされる。シーシャのライム系に共通する香り方の一本。',
  'hookafina:melon pop':
    'メロンとスイカを合わせた、アメリカのキャンディポップを思わせる甘い味わい。味付けはアメリカ的な方向性で、販売元の説明ではHookafinaの中でもウリ系フレーバーが好きな人に特に勧められる一本とされる。',
  'hookafina:mint knockout':
    'ベーシックでクラシックな造りのミント。販売元の説明では古いNakhlaのミントに似た方向性で、清涼感はAl Fakherのミントと同程度とされる。ベースのタバコ葉の味や火の回り方、清涼感の持ちが分かりやすく、ブランドの傾向を確かめるのに向く。',
  'hookafina:orange mint':
    'オレンジにミントを合わせたシンプルなフレーバー。オレンジはマルカワの風船ガムを思わせる素直な甘さで、Hookafinaらしく甘い系以外は透明感のある味付け。Ugly HookahやNu Hookahのフルーツフレーバーのさっぱりした味わいが好みなら合うとされる。',
  'hookafina:peppermint':
    '湿布に例えられるほど薬品的な香りと強い清涼感を持つ、方向性の尖ったペパーミント。万人向けではないが、ルートビアが好きな人には合うとされる。TangiersのBlitzsturmやWintergreen、StarBuzzのWinter Freshが好みなら候補になる。',
  'hookafina:pink grapefruit':
    'ピンクグレープフルーツの甘さと爽やかさを併せ持つ柑橘系フレーバー。販売元の説明では、他社のグレープフルーツやアイスグレープフルーツとはまた別種の味わいとされる。2012〜2015年頃に国内の多くの店舗で扱われた銘柄が再登場したもの。',
  'hookafina:spicy peach':
    '少しの甘さと爽やかさを持つピーチに、ごくわずかな引き締まり感が重なる一本。販売元の説明ではパッケージの唐辛子ほどの辛さは感じられず、キリッとした印象にとどまるとされる。抜けの爽やかさがあり吸いやすくまとまっている。',
  'hookafina:strawberry margarita':
    'ライムとテキーラを思わせる香りのマルガリータ系の土台に、ほのかでしつこさのないイチゴを重ねた一本。販売元の説明では、この爽やかなアルコール感のある抜けがレモネード&カクテルシリーズ共通のベースになっているとされる。',
  'hookafina:tutti fruiti':
    '特定の果実に寄らないフルーツミックス味。販売元の説明では国内では見かけにくいタイプで、フルーツ系全般が好みなら単品でも扱いやすいとされる。ミックスでフルーツの甘味を足す役としても使える。',
  'hookafina:vanilla shake':
    'バニラが香る、ルートビアを思わせる一本。同社のペパーミント系にある癖の強い清涼感へバニラ風味を足した構成で、販売元の説明ではファンネルボウルで吸う方がバランスが取りやすいとされる。コーラ系と合わせてコークフロート風のミックスにも。',
  'hookafina:watermelon mint':
    'スイカにミントの清涼感を合わせた、癖がなく吸いやすいフレーバー。販売元の説明では気軽に作れて気軽に吸える部類とされ、熱管理に神経を使わずに扱えるタイプ。',
  // AL AMASI — 日本の小売 (NEWEMO SHISHA) の商品説明を要約 (2026-09 時点)。
  // 販促文言・容器や在庫の案内は落とし、味の構成と使用上の注意のみを要約している。
  'al-amasi:chili sauce':
    '販売元の説明では辛さに特化したフレーバーで、辛味を足すだけでなく炭酸感やあたたかさの表現にも使えるとされる。刺激が強いため単品吸いは推奨されず、ミックスで2g程度が目安とされている。',
  'al-amasi:chocolate':
    'カカオがしっかりと主張するチョコレート。甘さとほろ苦さが同居する味わいで、高級チョコレートのような風味とされる。',
  'al-amasi:cola':
    '甘みとスパイス感のバランスが取れた、クラフトコーラ系のコーラフレーバー。清涼感は強めに出るとされる。',
  'al-amasi:curry spice':
    'カレースパイスの香りをそのまま写したフレーバー。',
  'al-amasi:energy bull':
    '販売元の説明では、市販のエナジードリンクの味を再現したフレーバーとされる。',
  'al-amasi:golden kiwi':
    'ゴールド系キウイをモチーフにした、芳醇な香りと甘さのあるフレーバー。グリーンキウイ系ではないぶん作りやすく吸いやすいとされる。',
  'al-amasi:golden orange':
    '程よい酸味と甘さを併せ持つオレンジ。酸味と甘さのバランスが取れた味わいにまとまっている。',
  'al-amasi:grape':
    'しっかりとした甘さと芳醇な深みを持つ、シーシャらしい定番のグレープ。クセが少なく作りやすい味とされる。',
  'al-amasi:grapefruit':
    '酸味が強すぎず、グレープフルーツジュースのような味わいのフレーバー。尖ったところがなく万人受けする方向にまとめられている。',
  'al-amasi:paprika':
    '単品ではそのままパプリカを感じる野菜系フレーバー。さまざまなミックスに合わせやすいとされる。',
  'al-amasi:rose':
    '甘みを伴い、上品ながらしっかりと主張するローズ。芳香剤のような人工的な感じが出にくい香り立ちとされる。',
  'al-amasi:vanilla':
    '人工的な印象を抑えた、バニラ本来の柔らかな甘みが軸のフレーバー。癖が少なく、ミックスの土台として使いやすいとされる。',
  'al-amasi:walnut':
  ...
  // KISMET (Kismet Noir) — smokedex.info の商品ページ (メーカー説明文 + 味の構成/方向性/ベース葉/
  // ニコチン強度) と htreviews.org の銘柄ページ (メーカー公式の一行説明 + 強さ + 評価) を要約 (2026-09 時点)。
  // 販促文言は落とし、味の構成と原料のみを採っている。
  // 公式が中程度〜強めとする強さに対し、htreviews のユーザー評価は中程度〜軽めに寄る。
  // ベース葉はバーレー/バージニア/オリエンタル/ダークエアキュアードの 4 種ブレンド (htreviews のブランド共通記載)。
  // 公告名とサイト側の綴りゆれ (Forrest/Forest, Jasmine/Jasmin, Violet/Violett) と
  // Black 接頭辞の有無 (Elixir) は対応表で吸収。htreviews のレビュー件数は 0〜3 件と少ないため点数は引用していない。
  'kismet:black apple':
    'ダブルアップルを土台にアニスを効かせた王道系。フルーティな甘さに酸味とスパイス感が重なり、ベースはダークブレンド、ニコチンは5段階中3でたばこ感は4と表記される。強さはメーカー公式が中程度〜強めとする一方、htreviews.orgではユーザー評価が中程度〜軽めに寄っている。',
  'kismet:black bisquit':
    'シナモン風味のクッキーであるスペキュロスを軸に、カルダモン・スターアニス・クローブ・オールスパイスを重ねた菓子系。公式の呼び方も「スパイスの効いたビスケット」で、甘さとクリーミーさにナッツのニュアンスと清涼感が絡む。公式は中程度〜強めの強さと案内するが、htreviews.orgではユーザー評価が中程度〜軽めに集まる。',
  'kismet:black cane':
    'ペパーミントキャンディを思わせる冷涼感と甘さを組み合わせた一本。ミントの冷たさに軽い砂糖菓子の甘みが寄り添う構成で、方向性は清涼感と夏向きの爽やかさ。ダークブレンドのベースながら、香りはミント主体でまとめられている。',
  'kismet:black flowers':
    'オリエントの香りをテーマにしたフローラル系で、花の香りに香辛料のニュアンスが重なる。公式説明ではカシミールのスパイスを合わせた花束と表現されており、果実的な甘さではなく香りの立ち方で構成されるタイプ。原産国はドイツ、ベースたばこはダークブレンドでニコチンは5段階中3。',
  'kismet:black forrest':
    '香木を主題にした落ち着いた一本だが、味の記述は資料によって分かれる。製品情報ではローズウッドとサンダルウッド(白檀)の組み合わせとされ、htreviews.orgでは公式説明としてサンダルウッド・ローズ・花のつぼみが挙げられており、木のローズウッドか花のローズかは断定できない。白檀の木質的でクリーミーな深みが軸にある点は共通する。',
  'kismet:black ginger':
    'ジンジャーレモネードを写したドリンク系。生姜のぴりっとした辛みに、弾けるような柑橘の酸味と軽い甘さが合わさる構成で、方向性はドリンク寄りとスパイス感。ベースはダークブレンドで、ニコチンは5段階中3とされる。',
  'kismet:black hazelnut':
    'ローストしたヘーゼルナッツの香ばしさを軸に、ビスケットの甘さとブルボンバニラをわずかに効かせたナッツ系。公式説明も「ナッツのクッキー」で、バターのような丸みを帯びた甘さが加わる。公式は強さを中程度〜強めと案内するものの、htreviews.orgではユーザーの評価が中程度〜軽めへ振れている。',
  'kismet:black hibiscus':
    'ハイビスカスの花を主役に据えたフローラル系。フルーティで酸味を伴う花の香りが中心で、公式説明にはスパイスミックスと土っぽいニュアンスも挙げられている。htreviews.orgでは3件と少数ながら、全員が「また吸いたい」と回答している。',
  'kismet:black jasmine':
    'ジャスミン一本で組み立てたフローラル系。花の香りに控えめな甘さが伴い、香りの要素を絞ったぶん輪郭がはっきり出る構成とされる。方向性もフローラルのみに振られており、ベースはダークリーフ、ニコチンの強さは5段階中3。',
  'kismet:black lavender':
    'ラベンダーのフローラルでやや苦味を帯びた香りに、ラズベリーの甘酸っぱさを合わせた組み合わせ。ベリーとフローラルの二方向で、花の香りが主体ながら果実の酸味が味の輪郭をつくる。原産国はドイツ、ベースはダークブレンド。',
  'kismet:black lemonade':
    'オレンジとレモンを使ったシトラスレモネード系。フルーティかつドリンク寄りの方向性で、柑橘の酸味と甘さが前面に出る構成になっている。ベースたばこはダークブレンドで、たばこ感の強さは5段階中4と記載されている。',
  'kismet:black majesty':
    '森のベリーとぶどうを組み合わせたフルーツ系。吸い始めに甘いベリーの果実味が立ち、遅れてグレープのジューシーさと軽い爽やかさが続く構成とされる。二つの果実の輪郭は最後まで分かれたまま重なる。方向性はフルーティとベリー、ベースはダークリーフ。',
  'kismet:black paan':
    'インドのパーンを下敷きにしたスパイスミックス。香辛料とハーブが甘み・苦み・清涼感を伴って重なり合い、方向性は清涼感とスパイス感の二つに絞られる。ブランドのたばこはバーレー・バージニア・オリエンタル・ダークエアキュアードをブレンドしたもので、ニコチンは5段階中3。',
  'kismet:black perfume':
    '香水をモチーフにしたフローラル系で、花の香りの深みに控えめな甘さとわずかなスパイスのニュアンスが寄り添う。方向性はフローラルのみに絞られており、ダークリーフのベースと合わせて香り重視の性格が強い。htreviews.orgでは銘柄固有の説明は見当たらない。',
  'kismet:black rose':
    '黒薔薇をモチーフにしたローズ系。濃厚な花の香りに軽いスパイス感が添えられ、オリエンタルな雰囲気を帯びる。方向性はフローラル単独で、甘さよりも香りそのものを味わうタイプ。htreviews.orgでは3件のレビューのうち、再喫の可否に答えた2人がいずれも「また吸いたい」としている。',
  'kismet:black sandalwood':
    'サンダルウッド(白檀)単体で構成した香木系。温かみのある木の香りに、ほのかな甘さと穏やかなスパイス感が伴う。方向性はスパイス寄りのみで、フルーツ系とは対照的な落ち着いた性格。ベースはダークブレンドのドイツ製。',
  'kismet:black tea':
    '淹れたての紅茶を想わせるティー系。渋みを含んだ深みのある味わいに、スパイシーさと軽い清涼感が重なる。ティー・ドリンク・酸味寄りの三方向で組まれており、ダークリーフのベースと相まって落ち着いた印象にまとまる。',
  'kismet:black vanilla':
    '公式が「フレンチバニラ」と案内するバニラ系。公表されている味の情報はこの一点のみで、方向性もそこに絞られる。強さについては公式が中程度〜強めとするのに対し、htreviews.orgではユーザー評価が中程度〜軽めに寄り、見立てに差がある。',
  'kismet:black violet':
    'スミレのキャンディをイメージした一本。花の甘い香りに砂糖菓子のような柔らかい甘さが重なり、フローラルの要素は突出しすぎない範囲に整えられているとされる。強さは公式が中程度〜強めと示すのに対し、htreviews.orgではユーザー評価が中程度〜軽め寄りとなっている。',
  'kismet:coffee cardamom':
    '深煎りコーヒーにカルダモンを効かせ、バニラをわずかに忍ばせた一本。ローストの香ばしさと香辛料の清涼感が同居し、方向性にはクリーミーさやナッツ感、酸味寄りの要素も並ぶ。htreviews.orgでは2件と件数は少ないものの、どちらも「また吸いたい」と答えている。',
  'kismet:elixir':
    'スズランとジャスミンを主役にした香水系の香り立ち。可憐な花の香りに乳香の煙たさが重なり、公式説明ではカルダモンとトンカビーンズのニュアンスも挙げられている。フローラルでありながら独特さとスパイス感を併せ持つ、ドイツ製のダークリーフ。',
  'kismet:elysium':
    '木の香りと花の香りを組み合わせた構成。吸い始めは柔らかくやや乾いた木質のニュアンスで、そこにフローラルな軽さが加わり、背景に控えめな清涼感が通るとされる。方向性はスパイス感とフローラル、ベースはダークブレンド。',
  'kismet:lemon rose':
    'ベルガモットの柑橘感に、ローズとジャスミンを重ねたフローラル系。公式説明ではほろ苦さと酸味が前に出るベルガモットに、繊細な甘さのジャスミンと生のローズを合わせたものとされる。方向性はフローラル一本に絞られ、ベースたばこはダークブレンドのドイツ製。',
  'kismet:orienttee al kashmir edition':
    'チャイに近いスパイスティー系。オリエンタルな茶葉の香りに、土のような温かみとハーブの清涼感、ほのかな甘さが混じり合う。ティー・酸味寄り・スパイス感の三方向で組み立てられており、ベースはダークリーフとなっている。',
  'kismet:peach blossom':
    '桃の果汁感と薔薇の甘い香りを合わせた一本。花の香りが先に立ち、そこへ穏やかな果実の甘さが続く構成で、方向性はフルーティとフローラル。強く主張するタイプではなく、輪郭は柔らかめとされる。ベースはダークブレンド。',
  'kismet:veritas':
    'お香の香りを主題にした変化球。樹脂のような煙たさとスパイス感が中心にあり、公式説明では乳香に加えてサンダルウッドも挙げられる。方向性には独自性・フルーティ・スパイス感が並び、たばこはバーレー・バージニア・オリエンタル・ダークエアキュアードのブレンド。',
  // Romman — smokedex.info の製品データ (味の構成・方向性・ベース葉・原産国) を要約 (2026-09 時点)。
  // 同サイトには Golden と Black の 2 ライン分の登録があるため、
  // 両ラインに同名銘柄があるものは対応が確定できず未記載。
  'romman:50g almond':
    'アーモンド由来のナッツ系フレーバー。ベースにはバージニア葉が使われ、原産はヨルダン。製品データではナッツ方向に分類される50gサイズである。',
  'romman:50g apple cinnamon':
    'アップルとシナモンの二本立てによる構成。果実感にスパイス感が乗る方向とされており、ヨルダン産のバージニア葉ベースで作られている50gサイズ。',
  'romman:50g banana split':
    'チョコレートとバナナを合わせた組み合わせの50gサイズ。酸味寄りかつクリーミーな方向に分類され、バージニア葉ベースのヨルダン産となっている。',
  'romman:50g blackberry':
    'ブラックベリーを単独で使ったベリー系のフレーバー。フルーティ方向とされ、ベースはバージニア葉、生産国はヨルダンと記載されている50gサイズ。',
  'romman:50g cappuccino':
    'コーヒーとバニラを合わせた、カプチーノ由来の名を持つ構成。方向性はクリーミーに分類される。ヨルダン産で、バージニア葉をベースとする50gサイズ。',
  'romman:50g cherry':
    'チェリーのみで組まれたシンプルな味。製品データ上はフルーティ方向に分類されており、バージニア葉をベースとするヨルダン産の50gサイズである。',
  'romman:50g chocolate':
    'チョコレート単体の構成による50gサイズ。甘さとクリーミーさに加えて冷涼な方向性も併記されており、ヨルダン産で、ベースはバージニア葉である。',
  'romman:50g cola':
    'コーラをモチーフにしたドリンク系のフレーバー。甘め寄りの方向とされ、バージニア葉をベースにヨルダンで生産されている50gサイズの一本である。',
  'romman:50g double apple':
    'ダブルアップルにアニスを重ねた構成の50gサイズ。酸味寄りでスパイス感のある方向とされ、ヨルダン産のバージニア葉ベースで作られている一本である。',
  'romman:50g grape':
    'グレープ単体で組まれたフレーバー。方向性はフルーティに分類されており、ベースはバージニア葉、原産国はヨルダンと記載されている50gサイズの一本。',
  'romman:50g guava':
    'グアバを使った南国系の味わい。フルーティさと酸味寄りの性格を併せ持つと分類されており、バージニア葉ベースでヨルダン製の50gサイズである。',
  'romman:50g laffy taffy':
    'キャラメル・バナナ・バニラの三種を重ねた構成。甘めでクリーミーな方向とされており、原産はヨルダン、ベースにはバージニア葉が用いられている。',
  'romman:50g lemon':
    'レモンを前面に出した柑橘系。方向性はフルーティに分類されており、バージニア葉をベースとしてヨルダンで生産されている50gサイズの一本である。',
  'romman:50g lime':
    'ライム単体で構成された柑橘系のフレーバー。製品データではフルーティ方向とされ、生産国はヨルダン、ベースにはバージニア葉が使われている50gサイズ。',
  'romman:50g mango':
    'マンゴーを軸にしたトロピカルフルーツ系。フルーティな方向に分類されており、ベースはバージニア葉、生産国はヨルダンと記載されている50gサイズ。',
  'romman:50g mint':
    'ミントのみのシンプルな構成で、方向性は清涼感とされている。ヨルダンで作られ、ベースにはバージニア葉が使われている50gサイズのフレーバー。',
  'romman:50g nectarine':
    'ネクタリンの名を冠するが、味の登録はピーチとなっている一本。方向性はフルーティとされ、バージニア葉ベースのヨルダン産の50gサイズである。',
  'romman:50g orange':
    'オレンジ単体で組まれた柑橘系フレーバー。製品データ上の方向性はフルーティに分類され、ヨルダンで生産され、ベースはバージニア葉となっている。',
  'romman:50g peach':
    'ピーチを主役にした構成のフレーバー。方向性はフルーティとされ、バージニア葉をベースとしてヨルダンで生産されている50gサイズの一本である。',
  'romman:50g pomegranate':
    'ザクロを単独で使ったフレーバー。方向性はフルーティに分類されており、原産国はヨルダン、ベースにはバージニア葉が用いられている50gサイズ。',
  'romman:50g rose':
    'ローズを用いたフローラル系。花の方向性に分類されるタイプで、バージニア葉ベース、ヨルダン産として登録されている50gサイズのフレーバー。',
  'romman:50g strawberry':
    'ストロベリー単体で組まれたベリー系。製品データ上の方向性はフルーティとされ、ヨルダンで生産され、ベースにはバージニア葉が使われている50gサイズ。',
  'romman:50g sweet melon':
    'ハニーデューメロンを使った構成のフレーバー。甘めでフルーティな方向に分類され、ベースはバージニア葉、原産はヨルダンとされる50gサイズ。',
  'romman:50g watermelon':
    'スイカを単独で立てたフレーバーで、製品データではフルーティ方向に分類される。ヨルダン産で、ベースにはバージニア葉が使われている50gサイズ。',
  'romman:almond':
    'アーモンドの風味を中心に据えたナッツ系のフレーバー。ベースはバージニア葉、原産国はヨルダンで、製品データ上の方向性もナッツ系に分類されている。',
  'romman:almond romman 125 gram tin':
    'アーモンドを軸にしたナッツ系のフレーバー。バージニア葉をベースとするヨルダン産で、製品データ上もナッツ方向に分類されている125g缶入りの一本。',
  'romman:apple':
    'アップル単体で構成された、シンプルな果実系のフレーバー。方向性はフルーティに分類されており、ヨルダン産でバージニア葉をベースとしている。',
  'romman:apple cinnamon romman 125 gram tin':
    'リンゴにシナモンを重ねた構成のフレーバー。フルーティさにスパイス感が加わる方向性とされ、ベースはバージニア葉、生産国はヨルダンと記載されている125g缶。',
  'romman:banana':
    'バナナを軸に組まれたフレーバー。フルーティさとクリーミーさが並ぶ方向に分類されており、ベースはバージニア葉、生産国はヨルダンと記載されている。',
  'romman:banana romman 50 gram box':
    'バナナ単体で組まれた味。フルーティかつクリーミーな方向に分類されており、ヨルダン産でバージニア葉をベースとする、50g箱入りのフレーバーである。',
  'romman:banana split':
    'チョコレートとバナナを重ねた、デザート由来の名を持つ構成。酸味寄りかつクリーミーな方向とされており、ヨルダン産でバージニア葉をベースとしている。',
  'romman:bay breeze':
    'パイナップル・ココナッツ・クランベリーを組み合わせたミックス。甘めでフルーティな方向に分類され、ベースはバージニア葉、原産はヨルダンとされている。',
  'romman:berry breeze':
    'ブルーベリーとストロベリーを合わせた二種のベリー構成。方向性はフルーティとされており、ヨルダン産で、ベースにはバージニア葉が使われている。',
  'romman:berry breeze romman 50 gram box':
    'ブルーベリーとストロベリーを合わせたベリー系のミックス。方向性はフルーティとされ、バージニア葉を土台にしたヨルダン産の50g箱入りとなっている。',
  'romman:berry crush':
    'ブルーベリー、ストロベリー、カラントにアイス要素を合わせた構成。フルーティかつクリーミーな方向とされ、バージニア葉ベースのヨルダン産となっている。',
  'romman:blackberry':
    'ブラックベリーを主体にしたベリー系のフレーバー。製品データ上の方向性はフルーティとされ、ヨルダンで生産され、ベースにはバージニア葉が使われている。',
  'romman:blueberry':
    'ブルーベリー単体で組まれた味わい。フルーティ方向に分類されており、バージニア葉をベースとするヨルダン産のフレーバーとして登録されている。',
  'romman:blueberry romman 50 gram box':
    'ブルーベリーを単独で立てた構成の50g箱入り。製品データではフルーティ方向に分類されており、ベースはバージニア葉、原産国はヨルダンとなっている。',
  'romman:cappuccino':
    'コーヒーとバニラによる、カプチーノを思わせる名を持つ構成。方向性はクリーミーに分類されており、ヨルダン産で、ベースはバージニア葉である。',
  'romman:cherry':
    'チェリーを軸にした果実系のフレーバー。方向性はフルーティとされ、ベースにはバージニア葉、生産地はヨルダンと製品データに記載されている一本である。',
  'romman:chocolate':
    'チョコレートを単独で使った構成のフレーバー。甘めでクリーミーな性格に加え、冷涼な方向性も併記されている。ヨルダン産でバージニア葉をベースとする。',
  'romman:chocolate mint':
    'ミントとチョコレートの二本立てによる構成。甘さ、清涼感、クリーミーさが並ぶ方向に分類されており、バージニア葉ベースのヨルダン産とされている。',
  'romman:chocolate mint romman 50 gram box':
    'ミントとチョコレートを組み合わせた50g箱入りの一本。甘さと清涼感、クリーミーさが並ぶ方向性とされる。バージニア葉をベースにしたヨルダン産である。',
  'romman:chocolate strawberry':
    'チョコレートにストロベリーを合わせた組み合わせ。フルーティで酸味寄りの方向とされており、ヨルダン産で、ベースはバージニア葉となっている。',
  'romman:chocolate strawberry romman 50 gram box':
    'チョコレートとストロベリーの組み合わせによる50g箱入り。フルーティで酸味寄りの方向に分類されている。原産はヨルダン、ベースにはバージニア葉が使われる。',
  'romman:cocktail':
    'アルコールとフルーツミックスを合わせたカクテル的な構成。フルーティ・ドリンク系で酸味寄りの方向に分類され、ヨルダン産のバージニア葉ベース。',
  'romman:coconut':
    'ココナッツを中心に組まれた味。クリーミーさとナッツ系の方向性が併記されており、ヨルダンで作られ、ベースにはバージニア葉が使われている。',
  'romman:coconut romman 50 gram box':
    'ココナッツを主役に据えた味で、50g箱入りのサイズ。クリーミーさとナッツ系の方向性を併せ持つと分類され、ヨルダン産でバージニア葉をベースとしている。',
  'romman:good times':
    'ミントにオレンジとレモンを重ねた構成のフレーバー。清涼感とフルーティさが並ぶ方向とされ、バージニア葉をベースとするヨルダン産である。',
  'romman:grape':
    'グレープを主役に据えたフレーバー。方向性はフルーティに分類され、原産国はヨルダン、ベースにはバージニア葉が用いられていると記載されている。',
  'romman:guava romman 125 gram tin':
    'グアバを軸にしたトロピカル系の構成。フルーティさに酸味寄りの性格が加わるとされ、ベースはバージニア葉、生産国はヨルダンと記載された125g缶である。',
  'romman:lemon mint':
    'ミントとレモンを合わせた組み合わせのフレーバー。清涼感とフルーティさの両方向に分類されており、ヨルダン産で、ベースはバージニア葉である。',
  'romman:lemon romman 125 gram tin':
    'レモンを単体で使ったシトラス系のフレーバー。方向性はフルーティに分類され、原産はヨルダン、ベースにはバージニア葉が用いられている125g缶入り。',
  'romman:licorice':
    'リコリス（甘草）を用いた構成で、酸味寄りかつスパイス感のある方向に分類されている。ベースにはバージニア葉が使われ、生産国はヨルダンとなっている。',
  'romman:mango':
    'マンゴー単体で組まれたトロピカルフルーツ系のフレーバー。製品データ上の方向性はフルーティで、生産国はヨルダン、ベースにはバージニア葉が使われている。',
  'romman:mango romman 125 gram tin':
    'マンゴーだけで構成されたトロピカルフルーツ系の125g缶。製品データ上の方向性はフルーティで、ヨルダンで作られ、バージニア葉をベースとしている。',
  'romman:melon berry':
    'ハニーデューメロンにベリー類を合わせたミックス。方向性はフルーティに分類されており、バージニア葉をベースとするヨルダン産となっている。',
  'romman:mint romman 125 gram tin':
    'ミント単体の構成で、方向性は清涼感に分類されている。バージニア葉をベースとしたヨルダン産で、125g缶のサイズで展開されているフレーバーである。',
  'romman:nectarine':
    'ネクタリンを名に持つが、味の登録上はピーチとして扱われている。方向性はフルーティとされ、ヨルダンで生産され、ベースはバージニア葉である。',
  'romman:pina colada':
    'パイナップル、ココナッツ、アルコールを合わせたカクテル由来の構成。フルーティ・ドリンク系でクリーミーな方向とされ、ヨルダン産のバージニア葉ベース。',
  'romman:raspberry':
    'ラズベリーを単独で使ったベリー系のフレーバー。方向性はフルーティに分類されており、ベースにはバージニア葉、原産国はヨルダンと記載されている。',
  'romman:sour kiss':
    'チェリー・オレンジ・ストロベリーを重ねた三種構成。甘めでフルーティな方向とされており、バージニア葉ベースで、ヨルダン産となっている一本。',
  'romman:spearmint':
  ...
  // AL-SULTAN — smokedex.info の製品データ (味の構成・方向性・ベース葉) を要約 (2026-09 時点)。
  // 公式サイト al-sultan.com は robots.txt で全面クロール禁止のため参照していない。
  'al-sultan:5 apples':
    'アップルとダブルアップルにアニスを重ねた構成が製品データに記載されている。方向性は酸味寄りとスパイス感の二軸で、ベースにはバージニア葉が用いられるとされる。',
  'al-sultan:black grape':
    '味の構成はグレープ単体として登録されている一本。方向性の区分は製品データ上には示されておらず、ベースにはバージニア葉が使われるとされている。',
  'al-sultan:blackberry':
    'ブラックベリーを主体としたフレーバーで、方向性はベリー系に分類されている。ベース葉はバージニア葉と記載されており、商品名どおり単一の果実で構成される。',
  'al-sultan:blueberry':
    'ブルーベリー単体の味わいとして登録された一本。方向性はベリー系に区分され、使用されるベース葉はバージニア葉とされている。商品名がそのまま内容を示す。',
  'al-sultan:cappuccino':
    '製品データ上の味の構成はコーヒーで、方向性はクリーミーに区分されている。商品名のとおりカプチーノを想定したコーヒー系の一本で、ベースはバージニア葉とされる。',
  'al-sultan:cherry':
    '味の構成はチェリーのみと登録されており、方向性はフルーティに区分されている。ベースにはバージニア葉が用いられるとされ、商品名どおり単一果実の内容となっている。',
  'al-sultan:cherry berry':
    'チェリーに各種ベリーを合わせた組み合わせとして記載されている。方向性はフルーティとベリー系の二つが挙げられ、ベース葉にはバージニア葉が使われるとされる。',
  'al-sultan:cinnamon':
    'シナモンを主軸に据えた構成で、方向性はスパイス感に分類されている。製品データではベースにバージニア葉が用いられるとされ、香辛料名を冠した単一フレーバーにあたる。',
  'al-sultan:cinnamon gum':
    'チューインガムとシナモンを組み合わせた内容として登録されている。方向性には清涼感とスパイス感の二つが挙げられ、ベース葉はバージニア葉と記載されている。',
  'al-sultan:coconut':
    'ココナッツ単体の構成で、方向性はナッツ系に区分されている。製品データ上のベース葉はバージニア葉であり、商品名がそのまま味の内容を示すかたちとなっている。',
  'al-sultan:energy drink':
    'エナジードリンクを模した味の構成とされ、方向性は甘めに分類されている。ベースにはバージニア葉が使われると記載されており、果実名を冠さないドリンク系の一本。',
  'al-sultan:fruit':
    '複数の果実を合わせたフルーツミックスとして登録されている一本。方向性はフルーティ、ベース葉はバージニア葉とされ、特定の果実名を冠さない構成となっている。',
  'al-sultan:grape lemon':
    'グレープとレモンを掛け合わせた構成が製品データに示されている。方向性はフルーティのみが挙げられ、ベースにはバージニア葉が用いられるとされている。',
  'al-sultan:grape mint':
    'ミントとグレープを組み合わせた内容として記載されている。方向性は清涼感とフルーティの二つで、ベース葉にはバージニア葉が使われるとされている。',
  'al-sultan:ice apple':
    'アップルにミントとメンソールを重ねた構成として登録されており、商品名のIceはこのメンソールに対応する。方向性は清涼感とフルーティで、ベースはバージニア葉とされる。',
  'al-sultan:ice cantaloupe':
    'ミントとハニーデューメロン、メンソールを合わせた構成と記載されている。方向性は清涼感とフルーティに分類され、ベース葉にはバージニア葉が使われるとされる。',
  'al-sultan:ice cherry':
    'チェリーにミントとメンソールを加えた構成として登録されている。方向性は清涼感とフルーティの二軸で、ベースにはバージニア葉が用いられるとされている。',
  'al-sultan:ice double apple':
    'ダブルアップルとアニスに、ミントとメンソールを重ねた構成とされる。方向性は清涼感・酸味寄り・スパイス感の三つが挙げられ、ベース葉はバージニア葉と記載されている。',
  'al-sultan:ice kaki':
    '味の内訳は製品データに登録されておらず、方向性として清涼感とフルーティが示されているのみ。商品名のIceが示すとおりの冷涼系にあたり、ベースはバージニア葉とされる。',
  'al-sultan:ice lemon':
    'レモンとメンソールという二つの要素で構成されると記載されている。方向性は清涼感とフルーティに区分され、ベース葉にはバージニア葉が使われるとされている。',
  'al-sultan:ice lemon mint':
    'ミント・レモン・メンソールの三要素を合わせた内容として登録されている。方向性は清涼感とフルーティに区分され、ベースにはバージニア葉が使われるとされる。',
  'al-sultan:ice orange':
    'オレンジにミントとメンソールを合わせた構成が製品データに記されている。方向性は清涼感とフルーティの二つで、ベース葉はバージニア葉とされている。',
  'al-sultan:lemon':
    'レモン単体の味の構成として登録されており、方向性はフルーティに分類される。ベースにはバージニア葉が使われるとされ、柑橘の名をそのまま冠した一本といえる。',
  'al-sultan:lemon mint':
    'ミントとレモンの二種を組み合わせた構成とされている。方向性には清涼感とフルーティが挙げられ、ベースにはバージニア葉が用いられると記載されている。',
  'al-sultan:mango':
    'マンゴー単体で構成されるフレーバーとして登録されている。方向性はフルーティ、ベース葉はバージニア葉とされ、商品名がそのまま味の内容を表すかたちとなっている。',
  'al-sultan:mint':
    'ミントのみで構成された一本として製品データに記載されている。方向性は清涼感に分類され、ベースにはバージニア葉が用いられるとされる、シンプルな内容の銘柄。',
  'al-sultan:mint gum':
    'ミントとチューインガムを合わせた内容として登録されている。方向性としては清涼感だけが挙げられており、ベース葉にはバージニア葉が使われるとされている。',
  'al-sultan:passion':
    'パッションフルーツを単体で用いた構成と記載されている。方向性はフルーティに区分され、ベースにはバージニア葉が使われるとされる、果実名そのままの一本。',
  'al-sultan:pineapple':
    'パイナップルを単一の要素として構成したフレーバーと記載されている。方向性の区分はフルーティで、ベースに用いられるのはバージニア葉とされている。',
  'al-sultan:strawberry':
    'ストロベリー単体の構成として製品データに登録されている。方向性はベリー系に分類され、ベース葉にはバージニア葉が使われるとされる、商品名どおりの内容。',
  'al-sultan:two apples':
    'ダブルアップルにアニスを合わせた構成として記載されている。方向性は酸味寄りとスパイス感の二軸で、ベースにはバージニア葉が用いられるとされている。',
  'al-sultan:waldmeister':
    '味の構成はウッドラフ（ヴァルトマイスター）と登録されている一本。方向性はフルーティに分類され、ベースにはバージニア葉が使われると記載されている。',
  'al-sultan:watermelon':
    'スイカ（ウォーターメロン）を単体で用いた構成として製品データに記載がある。方向性はフルーティに区分され、ベースにはバージニア葉が使われるとされている。',
  // Al Tawareg — smokedex.info の製品データ (味の構成・方向性・ベース葉) を要約 (2026-09 時点)。
  'al-tawareg:50g all american whiskey':
    '製品データではアルコール系の味に分類され、方向性はドリンク寄りかつ酸味寄りとされている。ベースたばこはバージニア葉、生産国はヨルダンと記載されている。',
  'al-tawareg:50g citrus lemon':
    'ライムとレモンを組み合わせた構成として登録されており、方向性はフルーティに区分される。ヨルダンで作られ、バージニア葉をベースにした銘柄とされる。',
  'al-tawareg:50g double apple':
    '商品名のとおりダブルアップル系で、味の構成はアップルとアニスとされている。方向性はフルーティかつ酸味寄り、ベースはバージニア葉で、ヨルダンで生産される50gの製品。',
  'al-tawareg:50g guava kuava':
    'グァバ単体の味として製品データに記載され、方向性はフルーティに区分されている。ベースはバージニア葉、原産国はヨルダンで、50gのパッケージで扱われる銘柄。',
  'al-tawareg:50g sweet honey':
    'ハチミツの味で登録され、甘め方向のカテゴリに置かれている一本。ベースたばこにはバージニア葉が使われ、生産国はヨルダン、内容量は50gと記載されている。',
  'al-tawareg:banana split al tawareg 50 gram box':
    'チョコレート・バナナ・バニラの三つを組み合わせた構成とされ、方向性は甘め。ヨルダンのメーカーによる、バージニア葉ベースの50gボックス製品と記載されている。',
  'al-tawareg:cappuccino al tawareg 50 gram box':
    'カプチーノを冠するものの、味データ上の登録はコーヒーで、方向性は甘め寄りとされている。バージニア葉をベースとし、ヨルダンで生産される50gの製品。',
  'al-tawareg:cherry blossom al tawareg 50 gram box':
    '味の登録はチェリーで、方向性はフルーティに区分されている。ベースはバージニア葉、産地はヨルダンと記され、50g入りとして扱われている銘柄。',
  'al-tawareg:citrus mint al tawareg 50 gram box':
    'ミントとレモンの組み合わせとして記載され、清涼感とフルーティの二方向に分類される。ヨルダン製で、ベースたばこにはバージニア葉が使われるとされる。',
  'al-tawareg:dark chocolate al tawareg 50 gram box':
    'チョコレートの味で登録されており、甘めと酸味寄りの両方向が示されている。バージニア葉をベースとするヨルダン産の製品で、50gのパッケージとされる。',
  'al-tawareg:fresh kiwi al tawareg 50 gram box':
    'キウイにメンソールを合わせた構成と記載され、清涼感のあるフルーティ系に分類されている。生産国はヨルダン、ベースはバージニア葉で、50g入りの銘柄。',
  'al-tawareg:juicy plum al tawareg 50 gram box':
    'プラムの味として製品データに登録され、フルーティ方向に区分される。ヨルダンで作られるバージニア葉ベースの銘柄で、50gのボックスで展開されている。',
  'al-tawareg:mixed grape al tawareg 50 gram box':
    '商品名どおりぶどう系で、製品データ上はグレープに分類され、方向性はフルーティとされている。ベースたばこはバージニア葉、原産国はヨルダンと記載。',
  'al-tawareg:orange cream al tawareg 50 gram box':
    'オレンジとバニラを合わせた構成として登録され、フルーティかつクリーミーな方向に分類されている。ヨルダン産でベースはバージニア葉、50g入りとされる。',
  'al-tawareg:sweet melon al tawareg 50 gram box':
    'ハネデューメロンとスイカを組み合わせた味とされ、甘めのフルーティ系に位置づけられている。バージニア葉ベースで製造はヨルダン、50gのボックス入り。',
  'al-tawareg:triple apple al tawareg 50 gram box':
    'トリプルアップルの名を持つが、味の登録はアップル単体で、フルーティに分類されている。ヨルダンのメーカー製で、ベースはバージニア葉、50g入りと記載。',
  'al-tawareg:wild apricot al tawareg 50 gram box':
    'アプリコットにベリーを組み合わせた構成として記載され、フルーティ方向に区分される。バージニア葉を使ったヨルダン産の製品で、50gのボックス展開。',
  'al-tawareg:wild watermelon al tawareg 50 gram box':
    'スイカとベリーを合わせた味で登録され、フルーティおよびベリー系の方向に分類されている。原産はヨルダン、ベースたばこはバージニア葉で、50g入り。',
  // ALFAKHAMAH — smokedex.info の製品データ (味の構成・方向性・ベース葉) を要約 (2026-09 時点)。
  'alfakhamah:blueberry':
    'ブルーベリーの味として製品データに登録され、方向性はベリー系に分類されている。ほかの素材の記載はなく、商品名どおり単一のベリーで組み立てられた構成とされる。',
  'alfakhamah:cherry':
    'チェリー単体の構成として記載されており、方向性はフルーティに区分される銘柄。味データ上はほかの素材を伴わず、商品名そのままのシンプルな組み立てとされている。',
  'alfakhamah:freeze passion fruit mango':
    'マンゴーとパッションフルーツにメンソールを合わせた構成と記載され、清涼感のあるフルーティ系に分類される。商品名の Freeze はこのメンソールを含む組み立てに対応する。',
  'alfakhamah:grape':
    '味の登録はグレープのみで、方向性はフルーティに位置づけられている。ほかの果実やミントの記載はなく、ぶどう系の単一フルーツとして整理されている銘柄。',
  'alfakhamah:guava':
    'グァバの味として分類され、フルーティに加えて酸味寄りの方向も併記されている。製品データ上はほかの素材を伴わず、グァバ単体で構成された一本とされる。',
  'alfakhamah:ice mint':
    'ミントとメンソールの二つで構成され、方向性は清涼感に区分されている。商品名の Ice は、このメンソールを含む冷涼側の組み立てに対応するものとされる。',
  'alfakhamah:melon':
    'ハネデューメロンの味として登録され、方向性はフルーティに分類されている。ほかの果実の記載はなく、メロン単体で組み立てられた構成と読み取れる銘柄。',
  'alfakhamah:mint':
    '商品名どおりミント単体の構成で、方向性は清涼感のカテゴリに置かれている。メンソールの記載はなく、製品データ上はミントのみで組み立てられた味とされる。',
  'alfakhamah:mojito':
    'アルコール・ミント・レモンを組み合わせた構成として記載されている。清涼感、フルーティ、ドリンク寄り、酸味寄りと、複数の方向にまたがって分類される一本。',
  'alfakhamah:orange':
    '商品名どおりオレンジの味で登録され、方向性はフルーティに区分されている。ほかの素材の記載はなく、柑橘単体で組み立てられた構成とされる銘柄。',
  'alfakhamah:passion fruit ice tea':
    'アイスティーとパッションフルーツを合わせた構成とされる。ティー系・清涼感・フルーティ・ドリンク寄りに分類され、名前どおり紅茶を軸にした一本と読み取れる。',
  'alfakhamah:peach':
    'ピーチ単体の味として製品データに載り、方向性はフルーティに分類されている。桃以外の素材は記載されておらず、商品名そのままの構成として整理されている。',
  'alfakhamah:peach ice tea':
    'ピーチとアイスティーの組み合わせで登録され、ティー、清涼感、フルーティ、ドリンク寄りと幅広く区分されている。商品名どおり、桃の紅茶を想定した構成。',
  'alfakhamah:pineapple':
    'パイナップルの味として記載され、方向性はフルーティに区分されている。ほかの果実やミントの記載はなく、単一のトロピカルフルーツで構成された銘柄とされる。',
  'alfakhamah:strawberry':
    'ストロベリーのみで構成され、方向性はフルーティに置かれている。製品データ上はほかの素材との組み合わせが示されておらず、いちご単体の味として登録されている。',
  'alfakhamah:two apple':
    'ダブルアップルにアニスを加えた構成として登録され、酸味寄りかつスパイス感のある方向に分類される。商品名の Two Apple はこのダブルアップル系を指すとされる。',
  // Khalil Maamoon — smokedex.info の製品データ (味の構成・方向性・ベース葉) を要約 (2026-09 時点)。
  // 同サイトの原産国欄は登録上の値で製造国の裏付けにならないため記載していない。
  'khalil-maamoon-tobacco:blueberry mint':
    '味の軸として挙がっているのはブルーベリーで、方向性は甘めのフルーティ系という位置づけ。商品名が示すとおりミントを組み合わせた一本であり、ベースにはバージニア葉が使われる。',
  'khalil-maamoon-tobacco:cactus lime':
    'カクタス（サボテン）とライムという二つの素材で味が組み立てられている。甘さとフルーティさに酸味寄りの性格が重なる方向とされ、葉はバージニア種が用いられている。',
  'khalil-maamoon-tobacco:fancy grape':
    '味の要素としてはグレープ単体が挙げられているフレーバー。方向性はフルーティさとクリーミーさの二本立てに分類され、ベースにはバージニア葉が使われている。',
  'khalil-maamoon-tobacco:grape malakee':
    'グレープだけを軸に据えたシンプルな味の構成。製品データ上は甘めのフルーティ系という分類で、ベースの葉にはバージニア種が使われている一本といえる。',
  'khalil-maamoon-tobacco:grape mint':
    'ミントとグレープを合わせた組み立てになっているフレーバー。甘さとフルーティさに清涼感が重なる方向へ分類され、バージニア葉をベースとする構成だ。',
  'khalil-maamoon-tobacco:ice apple':
    'アップルにメントールを重ねた二要素で味が作られているとされる。方向性は甘め・清涼感・フルーティの三つにまとめられ、ベースの葉はバージニア種。',
  'khalil-maamoon-tobacco:ice blackberry':
    'ブラックベリーとメントールの組み合わせが味の骨格をなしている。甘さと清涼感を伴うフルーティ系という方向づけがなされており、葉はバージニア種が使われる。',
  'khalil-maamoon-tobacco:ice cream blueberry vanilla':
    'アイス、ブルーベリー、バニラという三つの要素で味が構成されるフレーバー。甘さとクリーミーさに清涼感が加わる方向に分類され、ベースはバージニア葉とされている。',
  'khalil-maamoon-tobacco:melon mint':
    'ミントとハニーデューメロンを合わせた味の構成をとる。甘め・清涼感・フルーティという方向性が示されており、ベースの葉にはバージニア種が使われる。',
  'khalil-maamoon-tobacco:mint':
    '味の要素はミント単体のみという、きわめてシンプルな構成のフレーバー。方向性も清涼感を中心にまとめられており、ベースにはバージニア葉が用いられているとされる。',
  'khalil-maamoon-tobacco:peach aroma':
    'ピーチひとつで味が組み立てられている銘柄。製品データで挙がっている方向性はフルーティ系のみで、ベースの葉にはバージニア種が使われるという内容になっている。',
  'khalil-maamoon-tobacco:raspberry':
    'ラズベリーを単体で味の中心に据えた構成。甘さとフルーティさに酸味寄りの要素が加わる方向へ分類され、ベースにはバージニア葉が使われているという。',
  'khalil-maamoon-tobacco:two apple':
    'ダブルアップルにアニスを合わせた組み立てが味の中身とされる一本。方向性としては酸味寄りとスパイス感の二つが挙がっており、ベースの葉はバージニア種。',
  'khalil-maamoon-tobacco:watermelon mint':
    'ミントとウォーターメロンという二素材で味が構成されているフレーバー。甘め・清涼感・フルーティという方向に位置づけられ、ベースにはバージニア葉が使われる。',
  // Al Waha — smokedex.info の製品データ (味の構成・方向性・ベース葉・原産国) を要約 (2026-09 時点)。
  // 略称名 (LMO / CAKT 等) は smokedex 側で展開された味のみを採用し、名前からの推測はしていない。
  'al-waha:69':
    'コーラとオレンジを組み合わせた味の構成として記録されている。甘めのフルーティさとドリンク系という方向性で分類され、バージニア葉をベースにヨルダンで作られているとされる。',
  'al-waha:blueberry':
    '味の登録はブルーベリー単体で、方向性もベリー系のみが挙げられているフレーバー。ベースにはバージニア葉が使われ、製品データ上の生産国はヨルダンとなっている。',
  'al-waha:cola':
    'コーラを味の軸に据えた構成で、甘めのドリンク系という方向に分類されている。使用される葉はバージニア種、製造地はヨルダンとデータには記載されている。',
  'al-waha:crazy apple':
    '味の要素としてはアップルのみが登録されており、方向性もフルーティ系に絞られている。ベースはバージニア葉で、ヨルダン製造のラインに属する一本とされる。',
  'al-waha:hawaii beach':
    'パイナップル、ココナッツ、クリームという三つの要素で味が組み立てられている。甘さとフルーティさにクリーミーな方向が加わると分類され、葉はバージニア種、生産はヨルダン。',
  'al-waha:jlt':
    '味の構成はカクタス（サボテン）とレモンの組み合わせとして記録されている。甘めのフルーティさに酸味寄りの方向性が重なるとされ、バージニア葉をベースとするヨルダン産の製品。',
  'al-waha:lazourdi':
    'チューインガムとシナモンを合わせた味の組み立てになっている。方向性は甘さとスパイス感という分類で、ベースの葉はバージニア種、製造国はヨルダンと登録されている。',
  'al-waha:memories':
    'ミント、ピーチ、アイスティーの三要素から構成されるフレーバーとされる。ティー系およびドリンク系として扱われ、清涼感とフルーティさを伴う方向に分類されている。',
  'al-waha:nw rain':
    'ハニーにライムとレモンを合わせた構成が味の骨格になっている。分類は甘めのフルーティ系で、バージニア葉をベースとし、生産国はヨルダンと記録されている一本。',
  'al-waha:orange cream':
    'オレンジとクリームという二つの要素で味が構成されているフレーバー。甘さとフルーティさにクリーミーな方向性が加わるとされ、葉はバージニア種、製造地はヨルダン。',
  'al-waha:pan rasna':
    '味の登録内容はスパイスのみで、方向性もスパイス感に分類されている。ベースにはバージニア葉が用いられており、製品データ上はヨルダンで作られているとされる。',
  'al-waha:peach':
    'ピーチ単体を味の軸とした構成として記録されているフレーバー。方向性はフルーティ系のみが挙げられ、バージニア葉をベースにヨルダンで製造されているとされる。',
  ...
  // AFZAL — smokedex.info の製品データ (味の構成・方向性・ベース葉) を要約 (2026-09 時点)。
  'afzal:hookah molasses berry blast':
    'キウイ、ブラックベリー、ミント、ブルーベリーにベリー類を重ねた構成として登録されている。清涼感とフルーティ・ベリー方向が併記され、バージニア葉ベースのインド産。',
  'afzal:hookah molasses gingerelle':
    'ジンジャーとライムの組み合わせとして記録されている銘柄。方向性はフルーティかつ酸味寄りに分類され、バージニア葉を用いたインド製と記載されている。',
  'afzal:hookah molasses gum mastic':
    'フレーバーはチューインガム、すなわちガム系として登録されている。甘めとスパイス感の両方向に分類され、インドで作られるバージニア葉ベースの製品にあたる。',
  'afzal:hookah molasses honey':
    'フレーバー登録はハチミツのみで、製品データ上の方向性も甘め一系統にまとめられている。バージニア葉をベースとする、インド生産の molasses シリーズの一つ。',
  'afzal:hookah molasses lemon tea':
    'レモンの味わいを軸に、紅茶系・甘め・夏向き・フルーティといった複数の方向性が併記されている。製造国はインドで、ベースにはバージニア葉が使われるとされる。',
  'afzal:hookah molasses lychee':
    'ライチの風味として登録されており、製品データ上の方向性の分類は甘めのみ。原産国はインドで、土台となるたばこ葉はバージニア葉と記録されている。',
  'afzal:hookah molasses pan masala supreme':
    '商品名のとおりパーンマサラを冠した銘柄で、フレーバーの登録はスパイス。方向性は酸味寄りとスパイス感に分類され、バージニア葉を使うインド産とされる。',
  'afzal:hookah molasses pan raas':
    'フレーバー表記はスパイス、方向性についてもスパイス感のみと記されるパーン系の一本。インドで製造される製品で、ベースにはバージニア葉が用いられている。',
  // Nakhla — smokedex.info の製品データ (味の構成・方向性・ベース葉) を要約 (2026-09 時点)。
  // El Nakhla ライン以外 (Classic / El Basha / Mizo) は smokedex 側との対応が確定できず未記載。
  'nakhla:el nakhla banana':
    'バナナの味わいで構成される El Nakhla ラインの一銘柄。方向性はフルーティとクリーミーの二系統に分類され、バージニア葉を用いたエジプト産と記載される。',
  'nakhla:el nakhla coconut':
    'フレーバー表記はココナッツ単体で、方向性については甘めのみが挙げられている。エジプトで作られる、バージニア葉をベースとした製品と記録されている。',
  'nakhla:el nakhla mandarin':
    'マンダリンの味わいを軸にした銘柄として登録されている。製品データ上の方向性の分類はフルーティのみで、バージニア葉を土台とするエジプト産にあたる。',
  'nakhla:el nakhla vanilla':
    'バニラの風味として記録され、甘めとクリーミーという二つの方向性が併記されている。製造国はエジプト、ベースにはバージニア葉が使われるとされる。',
  // DEUS — htreviews.org のメインライン各ページ (公式説明・評価分布・リピート意向・レビュー) と
  // 日本の輸入元 sakurashisha.jp の商品説明を要約 (2026-09 時点)。Black Currant は各ソース未掲載のため未記載。
  // 財務省公告の旧表記 Gynness = Guinness、Pink Grapefruit = Rose Grapefruit (htreviews の露語名 «Розовый грейпфрут») は同一銘柄として説明を共有。
  'deus:base':
    'DEUSメインラインのノンアロマ・ベース。香料を加えず煮込みバーレイの落ち着いた自然なタバコ感に、ほのかなチョコと軽い渋み、草っぽい酸味が乗る。htreviewsでは評価5件と少数ながらリピート意向100%で、ミックスに足して強度を上げたり過剰な香料を薄める道具として好評、耐熱性も高い。',
  'deus:black berry':
    'ブラックベリーの濃厚な果実感を軸に、艶のある甘みと上品な酸味が長く余韻に残るベリー系フレーバー。',
  'deus:black ji':
    'クリーミーなアイスクリームにイラン産サフランを合わせた個性派デザート。htreviewsでは好みが真っ二つに割れ (評価68件・4点43%/5点26%、リピート意向70%)、低火力ではアイスが、高火力ではサフランが前に出るとされる。ヨーグルトやバニラ、ベリー系と好相性だが、ミックスでは他を塗り潰しやすいので少量から。',
  'deus:blackberry wine':
    'ブラックベリーワインの繊細な香りにベリーのブーケと軽いアルコール感、が公式説明。htreviewsでは酷評寄りで (評価63件・3点以下62%、リピート意向46%)、ワイン感はほぼなくブラックベリーが石鹸っぽいという指摘が多い。ソロより酸味のあるベリーやトロピカル系とのミックス向きで、火力を上げると石鹸感が強まる。',
  'deus:blueberry yogurt':
    'ヨーグルトのクリーミーさとブルーベリーの甘さを合わせた穏やかなデザート系。htreviewsでは4点が59%と安定 (評価48件、リピート意向67%) で、ブルーベリーは石鹸感がなく自然との声が多い一方、ヨーグルト感は薄くクリーミーなブルーベリーに近いとの指摘が目立つ。ミックスでは埋もれやすく30〜50%以上が推奨。',
  'deus:catmint':
    '甘いミントにパフュームの深みを重ねたDEUSの看板ミント。htreviewsでは評価123件で4点以上97%・リピート意向97%と圧倒的な支持で、清涼剤の冷たさはほぼなくスペアミントガムのような甘い爽やかさと軽い香水の余韻が特徴。梨・キウイ・青リンゴなどグリーン系とのミックスに特に好評で、ソロで吸えるミントとしても挙がる。',
  'deus:champagne':
    '甘く濃厚なアスティ系スパークリングワインに軽い酸味と発泡感、が公式説明。htreviewsでは辛口の安いスパークリングに近く発泡感はほぼ感じないという声が大半 (評価51件・4点以上56%、リピート意向72%)。ソロでは単調でミックスのアルコール系ベースとして活躍し、イチゴ・パイナップル・洋梨との組み合わせが勧められる。',
  'deus:cherry jelly':
    'ジューシーなチェリーゼリーをうたうベリー系。htreviewsでは3点が60%と低調で (評価30件、リピート意向48%)、石鹸感や種の苦味がなく吸いやすい反面、チェリーが水っぽく弱くゼリー感も薄いという指摘が多い。控えめな味を好む人向けで、過熱すると渋みやアーモンド様の苦味が出る。',
  'deus:cola':
    '甘くほどよくスパイシーな定番コーラを狙ったドリンク系。htreviewsでは酷評が優勢で (評価57件・3点以下68%、リピート意向24%)、気の抜けたコーラやコーラグミのような味でタバコベースの草っぽさが出やすいとの声が多い。ソロには不向きでミックスのベース用途に限るという意見が大半。',
  'deus:cooler':
    '冷感 (クーリング) 専用のミックス用フレーバー。htreviewsでは評価24件・5点54%、リピート意向90%と高評価で、余計な雑味がなく冷たさが最後まで持続する点が支持されている。効きが強いので数枚〜全体の3〜5%程度に留めるのが定石で、入れすぎると吸えなくなるという警告が複数ある。',
  'deus:elderberry':
    'エルダーフラワーの甘酸っぱい香りに渋みのあるベリー感を乗せた一本。htreviewsでは評価22件・4点以上55%、リピート意向72%で、ライチや紅茶を思わせる花の香りを伴う甘酸っぱいベリーとして概ね好評だが鮮やかさは控えめ。一部ロットで強い喉への刺激を報告する声が複数あり、蜂蜜や茶系とのミックスが勧められている。',
  'deus:elderberry wine':
    'エルダーベリーの奥行きのあるベリー感に、ワイン風のドライなニュアンスを重ねた構成。軽さよりも、静かに広がる重厚さが特徴です。',
  'deus:flower perfume':
    '花束のように華やかなフローラルアロマに、軽やかな甘みを添えた香水系フレーバー。甘みは軽く、花の香調が主体の構成です。',
  'deus:green apple':
    'シャープな酸味とみずみずしさを持つ青リンゴ。htreviewsでは評価31件・3点42%、リピート意向40%と伸び悩み、酸味はあるものの果汁感が薄く、アニスや石鹸のような後味を指摘する声が目立ちます。過熱すると味が抜けやすく、ソロより酸味担当としてミックス向きとされます。',
  'deus:guinness': DEUS_GUINNESS,
  'deus:gynness': DEUS_GUINNESS,
  'deus:jasmine pear':
    'シャキッとした中国梨にジャスミンの余韻、が公式説明。htreviewsでは4点52%が中心 (評価53件、リピート意向64%) だが、実際はジャスミンが主役で梨はほぼ感じないという声が大多数。ジャスミンは茶葉のような自然な香りで好評な一方、高火力では渋みや苦味が出るため炭は控えめに。紅茶系やベリーとのミックスに向く。',
  'deus:kiwi':
    '熟したキウイの果肉をうたうフルーツ系。htreviewsでは評価が割れ (評価41件・4点45%だが1〜2点も19%、リピート意向64%)、甘いジャム状のキウイと評する声と、皮のような草っぽさや未熟な渋みばかりでキウイに感じないという声が並ぶ。ソロでは単調になりやすく、酸味のあるフルーツやドリンク系とのミックス向き。',
  'deus:love is':
    'ガム「Love is」を再現した一本で、吸い込みはジューシーな苺、吐き出しは優しいバナナの余韻。htreviewsでは評価が真っ二つ (82件・リピート意向49%) で、ガムの再現度を評価する声と、化学的な甘さや20分前後で香りが抜けるという不満が並ぶ。',
  'deus:mango pineapple':
    '完熟マンゴーの濃厚な甘みに、パイナップルの爽やかな酸味を添えたトロピカル系。htreviewsでは評価36件で3点が47%、リピート意向58%と中庸で、実際は酸味のあるパイナップルが主役でマンゴーは控えめという声が大半。青臭さのない素直な甘さは好評ですが、ソロだと単調になりやすくミックス向きとされます。',
  'deus:marmelade':
    '甘酸っぱいマーマレードをグミベア風のキャンディ感で仕上げ、ベリーのニュアンスが重なるテイスト。htreviewsでは評価37件のうち1〜2点が49%、リピート意向33%と酷評優勢で、ソロでは酸味も甘みも薄く輪郭がないという声が多数。一方でミックスのベースにすると甘酸っぱさが活きるという擁護もあります。',
  'deus:melon':
    '公式は「熟した果汁たっぷりのメロン」だが、htreviewsでは青くて甘みの薄い乾いたメロンという評価が支配的 (14件・リピート意向0%)。ジューシーさが無くタバコ葉の風味が前に出るとの不満が多く、使うならミックスの脇役向きという声に留まる。',
  'deus:orange blossom':
    'オレンジそのものではなく、オレンジの花と皮を合わせた香水的なフローラル。htreviewsでは好みが真っ二つ (51件・1点20%/4点37%、リピート意向57%) で、石鹸や芳香剤と切り捨てる声と、少量で柑橘系やベリー系ミックスに花の輪郭を足す道具として評価する声が並ぶ。',
  'deus:orange tic tac':
    'オレンジ味のTic Tacを狙った、キャンディ調の甘いオレンジにミント様の軽い清涼感が乗る。htreviewsでは再現度が高いと好意的 (18件・4点67%、リピート意向91%) で、ファンタ寄りとの声や粉っぽさ・酸味不足の指摘はあるがソロで気軽に楽しめる一本。',
  'deus:passion fruit':
    '甘酸っぱいトロピカルなパッションフルーツで、化学臭が少なく自然寄りの再現。htreviewsではソロだと果汁感や酸味が物足りないが、トロピカル系ミックスに酸味を足す道具として非常に優秀という評価で一致している (34件・4点59%、リピート意向70%)。',
  'deus:peonies':
    '芍薬の花をテーマにした、柔らかく甘さ控えめの白い花のフローラルにパウダーと軽い草の質感。htreviewsでは高評価 (63件・4点以上79%、リピート意向83%) で、ベリー系ミックスに花の輪郭を足す用途で特に支持される。ソロは好みが分かれ、Deusの葉は過熱しやすいので火力は控えめに。',
  'deus:pine':
    'モミの木の樹脂と木質を再現した、針葉というより松脂そのものの濃厚な香り。htreviewsではサウナやセージ、パンラス系スパイスの連想が多く (37件・リピート意向82%)、ソロは重すぎるので柑橘やハーブ系ミックスに10〜20%程度で使う道具として評価が固まっている。',
  'deus:pink grapefruit': DEUS_PINK_GRAPEFRUIT,
  'deus:pink skittles':
    '同ブランドのSkittlesより酸味を抑え甘さを足した、ベリーとフルーツのキャンディ。htreviewsでは酸っぱさが苦手な人向けの穏やかな派生と受け止められる一方 (34件・4点65%、リピート意向75%)、キャンディ感が弱くぼやけた印象でオリジナルのほうが良いという声が目立つ。',
  'deus:pomegranate mors':
    '渋みと甘酸っぱさを持つザクロのモルス (果実飲料) を再現した、種や皮の要素の無い飲料寄りのザクロ。htreviewsでは穏やかで薄く水っぽいとの指摘が多く評価は中庸 (42件・4点40%、リピート意向63%)、ソロより赤系ミックスの土台向き。Deusの葉は過熱しやすい点にも注意。',
  'deus:raspberry':
    '熟したラズベリーの甘酸っぱさを狙ったナチュラル系だが、実際は砂糖漬けやジャムのような甘さ主体で酸味は控えめ。htreviewsでは安定した中〜高評価 (44件・4点以上56%、リピート意向73%) で、Peoniesなど花系との相性が良い。火力を上げると化学的な甘さが出るので控えめが向く。',
  'deus:red':
    'バラとコスメのパウダーを核にした「ヴィンテージ香水」のフレーバー。htreviewsでは高評価 (111件・4点以上85%、リピート意向82%) で、ソロは重いが10〜30%をミックスに加えるとパウダリーな奥行きが出る道具として絶賛される。一方で蝋のようで受け付けないという酷評も少数ある。',
  'deus:rose grapefruit': DEUS_PINK_GRAPEFRUIT,
  'deus:skittles':
    '定番キャンディの甘酸っぱさを狙うが、実際はライム/レモン系の強烈な酸味が主役でベリー感は薄い。htreviewsでは支持が多く (167件・4点以上70%、リピート意向78%) 緑のSkittlesの再現と評されるが、ソロでは酸っぱすぎて疲れるという声が多く、フルーツ系ミックスの酸味ブースターとしての使い方が定着している。',
  'deus:sour berries':
    '酸味を効かせたミックスベリー。htreviewsでは他社の酸系ほど刺激的でなく吸いやすいと好評な一方、ベリーの種類は判別しづらいという声が多い (リピート意向81%)。ソロでは酸が強すぎるとして、20〜30%の酸味ブースターとしてミックスに使う人が主流。過熱すると喉を刺す。',
  'deus:sour pineapple':
    'はっきりした酸味を前面に出したパイナップル。htreviewsでは評価が割れ (評価26件・4点54%・3点以下46%)、酸が酢っぽく化学的で果実が霞むという指摘が目立つ。ソロは賛否あり、20〜30%までのミックス用として使う人が多く、喉への刺激も報告されている。',
  'deus:strawberry':
    '完熟いちごのジューシーな甘みを、丸みのある上品な香りで表現したストロベリー。htreviewsでは評価55件・4点55%、リピート意向86%と高評価で、フレッシュな果実というよりジャムに近く、吸い進めるほど甘さが増すのが共通の感想。ソロでもミックスでも使いやすい一方、過熱すると甘さが重くなるため熱は控えめが推奨。',
  'deus:tropic soda':
    'パイナップルにパッションフルーツを重ねたトロピカルソーダ。htreviewsでは評価が低めで (評価30件・3点以下60%・リピート意向43%)、炭酸感がなく普通のトロピカルミックスだという不満が大半。パッションフルーツが前に出て、味が薄く平坦という声も多い。',
  'deus:ultima':
    'クルミとジンジャーという珍しい組み合わせ。htreviewsでは辛くない穏やかなジンジャーが主役でクルミは後ろに控えめ、という感想が大勢 (評価49件・4点61%・リピート意向78%)。毎日吸う味ではないがユニークと好評で、同社Yuzuとの50/50やレモン系とのミックスが定番。',
  'deus:vanilla berries':
    'イチゴとラズベリーにバニラパウダーをまぶした、甘く柔らかなデザート系。htreviewsでは評価が中庸で (評価62件・4点42%・3点37%・リピート意向53%)、ベリーの種類が判別できずバニラは粉砂糖のようだという声が多い。ソロでは飽きやすく、甘みやバニラを足すミックス用とされる。',
  'deus:viola':
    'ふんわり甘いマシュマロの質感に、ヴィオラ（スミレ）のフローラルを重ねた上品な香り。マシュマロの甘さと花の香りがやさしく溶け合う構成です。',
  'deus:violet zephyr':
    'ふわりとしたゼフィール (ロシアのマシュマロ菓子) にスミレの花香を添えたデザート系。htreviewsでは粉砂糖のようなパウダリーで控えめな甘さが特徴とされ、評価は割れる (評価92件・4点以上54%・3点以下46%)。花香を感じないという声や20〜30分で香りが落ちる指摘があり、弱めの熱が推奨。',
  'deus:watermelon halls':
    'スイカ味ののど飴 Halls を再現した、清涼感の強いキャンディ系スイカ。htreviewsでは清涼感が強すぎてスイカが背景に隠れるという指摘が最多で、スイカ自体もガムのように人工的という声が多い (評価38件・4点45%・3点37%)。ソロより夏向けミックスのクーラー役として使う人が目立つ。',
  'deus:wood':
    '針葉樹（パイン）の爽やかな香りを軸にした、森のようにクリアなウッディノート。ウッディな余韻が長く続くのが特徴です。',
  'deus:yuzu':
    'マンダリンと中国レモンの交配種ユズを再現した、酸味の効いたシトラス。htreviewsではDEUSの看板と言える高評価で (評価125件・4点62%・5点30%・リピート意向98%)、皮の苦みや酢っぽさのないジューシーな酸味が絶賛される。ミックスの酸味担当として重宝され、同社Ultimaとの50/50が人気。',
}
