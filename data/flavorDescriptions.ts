...
export const FLAVOR_DESCRIPTIONS: Record<string, string> = {
  ...
  // KISMET (Kismet Noir) — smokedex.info の商品ページ (メーカー説明文 + 味の構成/方向性/ベース葉/ニコチン強度) を要約 (2026-09 時点)。
  // 販促文言は落とし、味の構成と原料のみを採っている。
  // 公告名とサイト側の綴りゆれ (Forrest/Forest, Jasmine/Jasmin, Violet/Violett) と
  // Black 接頭辞の有無 (Elixir) は対応表で吸収。Black Vanilla は該当ページが無く未記載。
  'kismet:black apple':
    'ダブルアップルにアニスを効かせた王道系のフレーバー。フルーティな土台に酸味とスパイス感が重なる方向性で、ベースたばこはダークブレンド。製品情報ではニコチンの強さが5段階中3、たばこ感が同4と記載されている。ドイツ製。',
  'kismet:black bisquit':
    'シナモン風味のクッキーであるスペキュロスを軸に、シナモン・カルダモン・スターアニス・クローブ・オールスパイスを重ねた菓子系。甘さとクリーミーさ、ナッツのニュアンスに清涼感とスパイス感が加わる複雑な組み立てで、ベースはダークリーフ。',
  'kismet:black cane':
  ...
  'kismet:black flowers':
    'オリエントの香りをテーマに、フローラルさとスパイス感を組み合わせたブレンド。花の香りに香辛料のニュアンスが重なる方向で、果実的な甘さではなく香りの立ち方で構成されているタイプ。原産国はドイツ、ベースたばこはダークブレンド。',
  'kismet:black forrest':
    'ローズウッドとサンダルウッド(白檀)を合わせた香木主体の一本。ローズウッドのフローラルで軽くスパイシーな香りに、白檀の木質的でクリーミーな深みが重なる。清涼感とスパイス感を含む落ち着いた方向で、甘さより香りの質感が前に出る。',
  'kismet:black ginger':
  ...
  'kismet:black hazelnut':
    'ヘーゼルナッツのローストした香ばしさを軸に、ビスケットの甘さとブルボンバニラをわずかに効かせたナッツ系。バターのような丸みを帯びた甘さが加わり、方向性には酸味寄りとスパイス感も挙げられている。ドイツ製のダークリーフ。',
  'kismet:black hibiscus':
    'ハイビスカスの花を主役に据えたフローラル系。フルーティで酸味を伴う花の香りに、軽いスパイス感が添えられる。甘さで押すのではなく、酸味と花の輪郭で構成されているタイプで、ベースたばこはダークブレンドとなっている。',
  ...
  'kismet:black paan':
    'インドのパーンを下敷きにしたスパイスミックス。香辛料とハーブが甘み・苦み・清涼感を伴って重なり合い、複雑さのある味筋をつくる。方向性は清涼感とスパイス感の二つで、ベースたばこはダークブレンド、原産国はドイツ。',
  'kismet:black perfume':
    '香水をモチーフにしたフローラル系。花の香りの深みに、控えめな甘さとわずかなスパイスのニュアンスが寄り添う。方向性はフローラルのみに絞られており、ダークリーフのベースと合わせて香り重視の性格が強い一本。',
  'kismet:black rose':
    '黒薔薇をモチーフにしたローズ系。濃厚な花の香りに軽いスパイス感が添えられ、オリエンタルな雰囲気を帯びる構成とされる。方向性はフローラル単独で、甘さよりも香りそのものを味わうタイプ。ニコチンは5段階中3。',
  ...
  'kismet:black violet':
    'スミレのキャンディをイメージした一本。花の甘い香りに、砂糖菓子のような柔らかい甘さが重なる構成で、フローラルの要素は突出しすぎない範囲に整えられているとされる。方向性はキャンディとフローラル、ベースはダークブレンド。',
  'kismet:coffee cardamom':
    '深煎りコーヒーにカルダモンを効かせ、バニラをわずかに忍ばせた一本。ローストの香ばしさとカルダモンの清涼感が同居し、方向性にはクリーミーさやナッツ感、酸味寄りの要素も並ぶ。ベースたばこはダークブレンドで、原産国はドイツ。',
  'kismet:elixir':
    'スズラン、ジャスミン、そしてお香を組み合わせた香水系の香り立ち。可憐な花の香りにインセンスの煙たさが重なり、フローラルでありながらスパイス感と独特さを併せ持つ。ドイツ製のダークリーフで、ニコチンは5段階中3。',
  'kismet:elysium':
    '木の香りと花の香りを組み合わせた構成。吸い始めは柔らかくやや乾いた木質のニュアンスで、そこにフローラルな軽さが加わり、背景に控えめな清涼感が通るとされる。方向性はスパイス感とフローラル、ベースはダークブレンド。',
  'kismet:lemon rose':
    'ベルガモットの柑橘感に、ローズとジャスミンを重ねたフローラル系。ほろ苦さを含む爽やかな酸味と花の柔らかい香りが層になって現れる構成で、方向性はフローラル一本に絞られている。ベースたばこはダークブレンドのドイツ製。',
  ...
  'kismet:veritas':
    'お香の香りを主題にした変化球。樹脂のような煙たさとスパイス感が中心にあり、そこへ軽い果実味が加わる独特な組み立て。方向性にも独自性・フルーティ・スパイス感が並ぶ。ベースはダークリーフ、ニコチンは5段階中3。',
}
